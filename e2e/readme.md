...
Lumen's end-to-end testing aims to test the high-level functions of the
...
The post-meta test needs this must-use plugin so `lmn_e2e_dc_meta` is available
over the REST API:

`e2e/config/lumen-e2e-mu-plugin.php`
...
`wp-content/mu-plugins/lumen-e2e.php`.
