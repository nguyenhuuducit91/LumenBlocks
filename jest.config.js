...
module.exports = {
	...
	moduleNameMapper: {
		...
		lumen: '<rootDir>/src/test/lumen-mock.js',
	...
	collectCoverageFrom: [
		...
		'!src/block-library/ghost-button/**/*', // Deprecated block, don't test anymore.
		'!src/block-library/pullquote/**/*', // Deprecated block, don't test anymore.
		'!**/__test__/**/*',
	],
