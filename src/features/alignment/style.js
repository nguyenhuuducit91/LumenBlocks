export const addStyles = ( blockStyleGenerator, props = {} ) => {
	...
	const {
		selectorCallback = getAttribute => `.lmn--block-align-${ getAttribute( 'uniqueId' ) }`,
		editorSelectorCallback = getAttribute => `.lmn--block-align-${ getAttribute( 'uniqueId' ) }`,
		columnAlignSelectorEditCallback = ( () => '' ),
		columnAlignSelectorSaveCallback = ( () => '' ),
		innerBlockSelectorCallback = getAttribute => `.lmn-${ getAttribute( 'uniqueId' ) }-inner-blocks > .block-editor-inner-blocks > .block-editor-block-list__layout`,
		editorInnerBlockSelectorCallback = getAttribute => `.lmn-${ getAttribute( 'uniqueId' ) }-inner-blocks`,
		dependencies = [],
	} = props
