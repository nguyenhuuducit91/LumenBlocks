...
export const addSeparatorStyles = ( blockStyleGenerator, props ) => {
	...
	const {
		location = '',
		selector: _selector,
		wrapperSelector = '.lmn-separator__wrapper',
	...
	const selector = _selector !== undefined ? _selector : ` > .lmn-separator__${ location }`
...
const addMarginBottomStyles = ( blockStyleGenerator, props ) => {
	...
	blockStyleGenerator.addBlockStyles( 'textShadow', [ {
		...propsToPass,
		renderIn: 'edit',
		selector: _selector !== undefined ? _selector : ` > .lmn-separator__bottom`,
		styleRule: 'bottom',
...
export const addStyles = ( blockStyleGenerator, props = {} ) => {
	...
	doAction( 'lumen.block-component.separator.layer-styles.addStyles', blockStyleGenerator, {
		...props,
		location: 'top',
	} )
	doAction( 'lumen.block-component.separator.layer-styles.addStyles', blockStyleGenerator, {
