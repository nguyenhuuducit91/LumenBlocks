 ...
 */
if ( ! hasFilter( 'lumen.block-component.separator.layouts', 'default' ) ) {
	addFilter( 'lumen.block-component.separator.layouts', 'default', layouts => {
...
const SeparatorControl = props => {
	...
	const options = useMemo( () =>
		( applyFilters( 'lumen.block-component.separator.layouts', [] ) || [] )
			.filter( layouts =>
				findIndex(
					excludeDesigns,
