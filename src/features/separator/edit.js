...
const SeparatorControls = props => {
	...
	const separatorShadowOptions = applyFilters( 'lumen.separator.shadows', SEPARATOR_SHADOWS )
...
export const Edit = props => {
	const PremiumTopSeparatorControls = useMemo( () => applyFilters( 'lumen.block-component.separator.top.after', null ), [] )
	const PremiumBottomSeparatorControls = useMemo( () => applyFilters( 'lumen.block-component.separator.bottom.after', null ), [] )
