import { hexToRgba } from '~lumen/utils'
...
export const addStyles = ( blockStyleGenerator, props = {} ) => {
	...
	const selector = isCircle ? '.lmn-progress-circle' : '.lmn-progress-bar'
	...
	if ( ! isCircle ) {
		...
		blockStyleGenerator.addBlockStyles( 'progressColorGradientBlendMode', [ {
			...propsToPass,
			selector: '.lmn-progress-bar__bar.lmn--has-background-overlay:before',
