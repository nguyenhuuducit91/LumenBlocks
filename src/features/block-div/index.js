...
import { useVariationPicker } from '~lumen/hooks'
...
export const BlockDiv = memo( props => {
	...
	uniqueBlockClass = applyFilters( 'lumen.block-div.uniqueClass.edit', uniqueBlockClass )
	...
	const classNames = classnames( applyFilters( 'lumen.block-components.block-div.classnames',
		[
			className,
			'lmn-block',
			blockHoverClass,
			...
			attributes.blockStyle,
			{
				...
				'lmn-block-background': attributes.hasBackground,
				[ `lmn--background-scheme--${ attributes.backgroundColorScheme }` ]: attributes.hasBackground && attributes.backgroundColorScheme,
				...
				'lmn--block-margin-top-auto': attributes.blockMargin?.top === 'auto',
				'lmn--block-margin-right-auto': attributes.blockMargin?.right === 'auto',
				'lmn--block-margin-bottom-auto': attributes.blockMargin?.bottom === 'auto',
				'lmn--block-margin-left-auto': attributes.blockMargin?.left === 'auto',
			},
		],
		props
	) )
	...
	return <Div
		...
		{ ...applyFilters( 'lumen.block-components.block-div.attributes', {}, attributes ) }
	>
		{ props.children }
...
BlockDiv.Content = props => {
	...
	uniqueBlockClass = applyFilters( 'lumen.block-div.uniqueClass.save', uniqueBlockClass, attributes )

	const classNames = classnames( applyFilters( 'lumen.block-components.block-div.classnames.content',
		[
			className,
			'lmn-block',
			uniqueBlockClass,
			attributes.blockStyle,
			{
				...
				'lmn--has-lightbox': attributes.blockLinkHasLightbox || attributes.linkHasLightbox,
			},
		],
		props
	) )
	...
	return <Div.Content
		...
		backgroundThumbnailUrlMobile={ attributes.blockBackgroundMediaThumbnailUrlMobile }
		backgroundColorType={ attributes.blockBackgroundColorType }
		{ ...applyFilters( 'lumen.block-components.block-div.attributes.content', {}, attributes ) }
	/>
}
