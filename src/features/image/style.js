...
export const addStyles = ( blockStyleGenerator, props = {} ) => {
	...
	const {
		selector = '.lmn-img-wrapper',
		hoverSelector = '.lmn-img-wrapper:hover',
	...
	blockStyleGenerator.addBlockStyles( 'imageAspectRatio', [ {
		...
		selector: [
			selector,
			`${ selector } .lmn-img-resizer-wrapper`,
		],
		renderIn: 'edit',
	...
	blockStyleGenerator.addBlockStyles( 'imageWidth', [ {
		...propsToPass,
		selector: `${ selector }:not(.lmn--is-resizing)`,
		renderIn: 'edit',
		styleRule: 'width',
		attrName: 'imageWidth',
		key: 'imageWidth',
	...
	blockStyleGenerator.addBlockStyles( 'imageShadow', [ {
		 ...
		 */
		selector: `${ selector } .lmn-img-resizer-wrapper`,
		hoverSelector: hoverSelector ? `${ hoverSelector } .lmn-img-resizer-wrapper` : undefined,
	...
	blockStyleGenerator.addBlockStyles( 'imageBorderRadius', [ {
		 ...
		 *
		 */
		selector: `${ selector } .lmn-img-resizer-wrapper img`,
		renderIn: 'edit',
	...
	blockStyleGenerator.addBlockStyles( 'imageShape', [ {
		...
		selector: [
			`${ selector } .lmn-img-resizer-wrapper img`,
			`${ selector } .lmn-img-resizer-wrapper::after`,
			`${ selector } .lmn-img-resizer-wrapper::before`,
		],
	...
	blockStyleGenerator.addBlockStyles( 'imageOverlayColor', [ {
		...
		...propsToPass,
		renderIn: 'edit',
		selector: `${ selector } .lmn-img-resizer-wrapper::after`,
		hoverSelector: `${ hoverSelector } .lmn-img-resizer-wrapper::after`,
		hoverSelectorCallback,
		styleRuleCallback: getAttribute => {
			const colorType = getAttribute( 'imageOverlayColorType' )
			return colorType === 'gradient' ? 'backgroundImage' : 'backgroundColor'
	...
	blockStyleGenerator.addBlockStyles( 'imageOverlayOpacity', [ {
		...
		selector: `${ selector }`,
		hoverSelector: `${ selector }::before`,
		styleRule: '--lmn-gradient-overlay',
		...
		renderIn: 'edit',
		selector: `${ selector } .lmn-img-resizer-wrapper`,
		hoverSelector: `${ selector } .lmn-img-resizer-wrapper::before`,
		styleRule: '--lmn-gradient-overlay',
		attrName: 'imageOverlayOpacity',
	...
	blockStyleGenerator.addBlockStyles( 'imageOverlayBlendMode', [ {
		...
		...propsToPass,
		renderIn: 'edit',
		selector: `${ selector } .lmn-img-resizer-wrapper::after, ${ selector } .lmn-img-resizer-wrapper::before`,
		hoverSelectorCallback,
		styleRule: 'mix-blend-mode',
		attrName: 'imageOverlayBlendMode',
