...
export const useColumn = () => {
	...
	const onResetDesktop = () => {
		...
		if ( adjacentBlocks.length ) {
			...
			dispatch( 'core/block-editor' ).updateBlockAttributes( clientIds, { columnWidth: '' } ) // eslint-disable-line lumen/no-update-block-attributes
		}
	}
	...
	const onResetTabletMobile = () => {
		...
		if ( adjacentBlocks.length ) {
			const clientIds = adjacentBlocks.map( block => block.clientId )
			dispatch( 'core/block-editor' ).updateBlockAttributes( clientIds, { columnWidthTablet: '', columnWidthMobile: '' } ) // eslint-disable-line lumen/no-update-block-attributes
		}
	}
