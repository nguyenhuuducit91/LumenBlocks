...
if ( ! class_exists( 'Lumen_Getting_Started_Screen' ) ) {
	class Lumen_Getting_Started_Screen {
		function __construct() {
            ...
            if ( is_admin() ) {
                add_filter( 'lumen_localize_script', array( $this, 'add_localize_script' ) );
                add_filter( 'lumen_localize_settings_script', array( $this, 'add_localize_script' ) );
            }
        }
        ...
        public function add_localize_script( $args ) {
            $args['guidedTourStates'] = get_option( 'lumen_guided_tour_states', array() );
            return $args;
        }
	}

	new Lumen_Getting_Started_Screen();
}