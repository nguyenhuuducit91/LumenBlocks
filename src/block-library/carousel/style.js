...
blockStyles.addBlockStyles( 'arrowJustify', [ {
	selector: '.lmn-block-carousel__buttons',
...
blockStyles.addBlockStyles( 'arrowButtonColor', [ {
	selector: '.lmn-block-carousel__button',
	hoverSelector: '.lmn-block-carousel__button:hover',
...
blockStyles.addBlockStyles( 'arrowIconColor', [ {
	...
	selector: '.lmn-block-carousel__button svg.lmb-custom-icon :is(g,path,rect,polygon,ellipse)',
	hoverSelector: '.lmn-block-carousel__button svg.lmb-custom-icon :is(g,path,rect,polygon,ellipse):hover',
	styleRule: 'fill',
	attrName: 'arrowIconColor',
	key: 'arrowIconColor',
	hover: 'all',
...
blockStyles.addBlockStyles( 'arrowIconSize', [ {
	selector: '.lmn-block-carousel__button svg',
	styleRule: 'width',
...
blockStyles.addBlockStyles( 'dotsJustify', [ {
	selector: '.lmn-block-carousel__dots',
	styleRule: 'justifyContent',
...
blockStyles.addBlockStyles( 'dotsColor', [ {
	selector: '.lmn-block-carousel__dot',
	hoverSelector: '.lmn-block-carousel__dot',
	styleRule: '--dot-color',
...
blockStyles.addBlockStyles( 'dotsActiveColor', [ {
	selector: '.lmn-block-carousel__dot.lmn-block-carousel__dot--active:before',
...
blockStyles.addBlockStyles( 'dotsBorderRadius', [ {
	selector: '.lmn-block-carousel__dot:before',
	styleRule: 'borderRadius',
