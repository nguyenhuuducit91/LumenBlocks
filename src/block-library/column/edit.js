...
import { useBlockLayoutDefaults, usePresetControls } from '~lumen/hooks'
import {
...
const Edit = props => {
	...
	const {
		...
		select => {
			...
			return {
				...
				parentBlock,
				useZeroColumnSpacing: ! [ 'lumen/timeline' ].includes( parentBlock.name ),
			}
		},
		[ clientId ]
	)
	...
	const ALLOWED_INNER_BLOCKS = applyFilters( 'lumen.block.column.allowed-inner-blocks', undefined, props )
