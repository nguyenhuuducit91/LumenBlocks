...
addFilter( 'lumen.notification.save.close-button-props', 'lumen/3.19.0', ( buttonProps, props ) => {
...
addFilter( 'lumen.notification.save.innerClassNames', 'lumen/3.8.0', ( output, props ) => {
