...
const variations = [
	...
	},
	{
		...
		isDefault: true,
		innerBlocks: [ [ 'lumen/column' ], [ 'lumen/column' ] ],
		scope: [ 'block' ],
	},
	{
		...
		innerBlocks: [
			[ 'lumen/column', { columnWidth: 33.3 } ],
			[ 'lumen/column', { columnWidth: 66.7 } ],
		],
		scope: [ 'block' ],
	},
	{
	...
	},
	{
		...
		innerBlocks: [
			[ 'lumen/column', { columnWidth: 25 } ],
			[ 'lumen/column', { columnWidth: 50 } ],
			[ 'lumen/column', { columnWidth: 25 } ],
		],
		scope: [ 'block' ],
	},
