...
// Version 3.6.2 Deprecations, we now don't need the lmn--has-column-order class.
addFilter( 'lumen.columns.save.contentClassNames', 'lumen/3.8.0', ( classes, props ) => {
	if ( semverCompare( props.version, '<', '3.8.0' ) ) {
		return [
			...classes,
			{
				// This makes the `--lmn-col-order-#` custom properties to get
...
// Column wrapping now adds the lmn--column-wrap-desktop class.
addFilter( 'lumen.columns.save.contentClassNames', 'lumen/3.19.8', ( classes, props ) => {
