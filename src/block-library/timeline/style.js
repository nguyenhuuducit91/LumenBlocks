...
blockStyles.addBlockStyles( 'timelineAnchor', [ {
	selector: [ '', '~ .lmn-block-timeline' ], // Also set the succeeding ones.
...
blockStyles.addBlockStyles( 'blockPadding', [ {
	renderIn: 'save',
	selector: '.lmn-inner-blocks:after',
	styleRule: 'top',
	...
	renderIn: 'save',
	selector: '.lmn-block-timeline__middle',
	styleRule: 'marginTop',
	attrName: 'blockPadding',
...
Typography.addStyles( blockStyles, {
	selector: '.lmn-block-timeline__date',
	hoverSelector: '.lmn-block-timeline__date:hover',
} )
