...
blockStyles.addBlockStyles( 'columns', [ {
	selector: '.lmn-table-of-contents__table',
...
blockStyles.addBlockStyles( 'rowGap', [ {
	...
	renderIn: 'edit',
	selector: '.lmn-block-table-of-contents__list-item-inner',
	styleRule: 'marginBottom',
	attrName: 'rowGap',
	key: 'rowGapEdit',
	responsive: 'all',
	...
	selector: '.lmn-table-of-contents__table ul',
	styleRule: 'marginTop',
	attrName: 'rowGap',
	key: 'rowGap-top',
	responsive: 'all',
...
Typography.addStyles( blockStyles, {
	selector: '.lmn-table-of-contents__title',
	hoverSelector: '.lmn-table-of-contents__title:hover',
