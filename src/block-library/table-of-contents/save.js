...
export const Save = props => {
	...
	const blockClassNames = classnames( applyFilters( 'lumen.table-of-contents.save.blockClasses', [
		className,
	...
	const tableOfContentsClassNames = applyFilters( 'lumen.table-of-contents.save.tableOfContentsClasses', classnames( [
