	...
	[
		{
			...
			innerBlocks: [
				[ 'lumen/column', {
					...
					className: 'lmn--container-small lmn-block-accordion__heading',
				}, [
					[ 'lumen/icon-label', {}, [
						[ 'lumen/heading', {
				...
				[ 'lumen/column', { templateLock: false, className: 'lmn-block-accordion__content' }, [
					[ 'lumen/text', {
		...
		},
		{
			...
			innerBlocks: [
				...
				[ 'lumen/column', {
					templateLock: false,
					className: 'lmn-block-accordion__content',
					containerPadding: {
