...
/**
 * Add `autocompleters` support for lumen/heading
 *
 * @see ~lumen/util/blocks#createBlockCompleter
 */
addFilter( 'editor.Autocomplete.completers', 'lumen/heading', ( filteredCompleters, name ) => {
	if ( name === 'lumen/heading' ) {
...
const Edit = props => {
	...
	// Auto-generate anchors in Lumen headings.
