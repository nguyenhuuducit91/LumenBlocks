...
import { getAttributeName as _getAttributeName } from '~lumen/utils'
...
export const blockStyles = [
	{
		...
		onSelect: ( _, props ) => {
			...
			return {
				...ATTRIBUTES_TO_CLEAR,
				...( props.context[ 'lumen/tabOrientation' ] !== 'vertical' ? willSetAttributesHorizontal : willSetAttributesVertical ),
			}
		},
	},
	{
