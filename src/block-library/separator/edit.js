		...
		<>
			...
			>
				<div className={ separatorClassNames }>
					...
					/>
					{ applyFilters( 'lumen.block.separator.edit.output.layers', null, props ) }
				</div>
			</BlockDiv>
...
const InspectorControls = memo( props => {
	const PremiumSeparatorControls = useMemo( () => applyFilters( 'lumen.block.separator.edit.after', null ), [] )
	return (
		<>
