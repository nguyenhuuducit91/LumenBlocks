...
class LumenVideoPopup {
	init = () => {
		const els = document.querySelectorAll( '.lmn-block-video-popup' )
...
window.lumenVideoPopup = new LumenVideoPopup()
domReady( window.lumenVideoPopup.init )
