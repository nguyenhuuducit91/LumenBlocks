...
export const Divider = props => {
	...
	return (
		<div className="lmn-block-countdown__divider-wrapper">
			{ attributes.dividerType === ':' && <div className="lmn-block-countdown__divider-colon">:</div> }
			{ attributes.dividerType === '|' && <div className="lmn-block-countdown__divider-line"></div> }
		</div>
...
const addStyles = ( blockStyleGenerator, props = {} ) => {
	...
	blockStyleGenerator.addBlockStyles( 'dividerColor', [ {
		...propsToPass,
		selectorCallback: getAttribute => getAttribute( 'dividerType' ) === ':' ? '.lmn-block-countdown__divider-colon' : '.lmn-block-countdown__divider-line',
	...
	blockStyleGenerator.addBlockStyles( 'dividerSizeLine', [ {
		...propsToPass,
		selector: '.lmn-block-countdown__divider-line',
		styleRule: 'height',
	...
	blockStyleGenerator.addBlockStyles( 'dividerSizeColon', [ {
		...propsToPass,
		selector: '.lmn-block-countdown__divider-colon',
		styleRule: 'fontSize',
