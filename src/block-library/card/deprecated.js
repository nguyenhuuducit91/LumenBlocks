...
// Version 3.8 added horizontal flex, this changes the lmn--block-orientation-* to lmn--block-horizontal-flex.
addFilter( 'lumen.card.save.innerClassNames', 'lumen/3.8.0', ( output, props ) => {
...
addFilter( 'lumen.card.save.container-div.content', 'lumen/3.0.2', ( output, props, innerClassNames ) => {
...
addFilter( 'lumen.card.save.contentClassNames', 'lumen/3.0.2', ( output, props ) => {
	if ( compareVersions( props.version, '3.0.2' ) === 1 ) {
		return output
	}
...
addFilter( 'lumen.card.save.wrapperClassNames', 'lumen/3.0.2', ( output, props ) => {
	if ( compareVersions( props.version, '3.0.2' ) === 1 ) {
		return output
	}
...
addFilter( 'lumen.card.save.innerClassNames', 'lumen/3.0.2', ( output, props ) => {
	if ( compareVersions( props.version, '3.0.2' ) === 1 ) {
		return output
	}
	...
	output.push( {
		...
		'lmn-container-padding': props.attributes.hasContainer,
	} )
