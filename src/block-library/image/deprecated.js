...
addFilter( 'lumen.image.save.wrapper', 'lumen/image-link-wrapper', ( output, props, imageWrapperClasses, image, figcaptionClassnames ) => {
	if ( ! props.version ) {
		return output
	}
...
addFilter( 'lumen.image.save.wrapper', 'lumen/image-caption-wrapper', ( output, props, imageWrapperClasses, image ) => {
	if ( ! props.version ) {
		return output
	}
