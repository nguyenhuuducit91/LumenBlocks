...
const Edit = props => {
	...
	if ( innerBlocks?.length ) {
		tabLabelsBlock = innerBlocks[ 0 ].name === 'lumen/tab-labels' ? innerBlocks[ 0 ] : innerBlocks[ 1 ]
		tabContentBlock = innerBlocks[ 0 ].name === 'lumen/tab-content' ? innerBlocks[ 0 ] : innerBlocks[ 1 ]
	}
	...
	return (
		<>
			...
			>
				...
				<CustomCSS mainBlockClass="lmn-block-tabs" />
...
const InspectorControls = memo( props => {
	return (
		<>
						...
						if ( props.hasMultiSelectedBlocks ) {
							props.multiInnerBlocks.forEach( _innerBlocks => {
								if ( _innerBlocks?.length ) {
									const _tabLabelsBlock = _innerBlocks[ 0 ].name === 'lumen/tab-labels' ? _innerBlocks[ 0 ] : _innerBlocks[ 1 ]
			...
			<CustomCSS.InspectorControls mainBlockClass="lmn-block-tabs" />
