...
blockStyles.addBlockStyles( 'flexWrap', [ {
	...
	renderIn: 'edit',
	selector: '.lmn-button-group .block-editor-block-list__layout',
	styleRule: 'flexWrap',
	attrName: 'flexWrap',
	key: 'flexWrap',
	responsive: 'all',
...
blockStyles.addBlockStyles( 'buttonFullWidth', [ {
	renderIn: 'save',
	selector: '.lmn-block-button, .lmn-block-icon-button',
	styleRule: 'flex',
	...
	renderIn: 'edit',
	selector: `.lmn-block-button, .lmn-block-icon-button, [data-type^="lumen/"]`,
	styleRule: 'flex',
	attrName: 'buttonFullWidth',
	key: 'buttonFullWidth',
	valueCallback: ( value, getAttribute ) => {
...
blockStyles.addBlockStyles( 'flexWrap', [ {
	renderIn: 'save',
	selector: '.lmn-button-group',
	styleRule: '--lmn-button-group-flex-wrap',
	attrName: 'flexWrap',
	...
	renderIn: 'save',
	selector: '.lmn-button-group .lmn-block-button',
	styleRule: 'width',
	attrName: 'flexWrap',
...
BlockDiv.addStyles( blockStyles, {
	verticalAlignSelectorEdit: '.lmn-button-group > .block-editor-inner-blocks > .block-editor-block-list__layout',
	verticalAlignSelectorSave: '.lmn-button-group',
} )
