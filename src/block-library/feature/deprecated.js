...
addFilter( 'lumen.feature.save.contentClassNames', 'lumen/3.0.2', ( output, props ) => {
...
addFilter( 'lumen.feature.save.innerClassNames', 'lumen/3.0.2', ( output, props ) => {
	if ( compareVersions( props.version, '3.0.2' ) === 1 ) {
		return output
	}
...
addFilter( 'lumen.feature.save.innerClassNames', 'lumen/3.8.0', ( output, props ) => {
