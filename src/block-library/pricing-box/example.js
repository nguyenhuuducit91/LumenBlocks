...
export default {
	attributes: {
		...
		name: 'lumen/subtitle', attributes: {
		...
		name: 'lumen/icon-list', attributes: {
		...
		name: 'lumen/button-group', attributes: {
