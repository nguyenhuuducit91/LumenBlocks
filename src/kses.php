...
if ( ! function_exists( 'lumen_allow_wp_kses_allowed_html' ) ) {
	 ...
	 * this allows Lumen HTML tags & attributes from being saved.
	 *
	 * For every Lumen block, add the HTML tags and attributes used here.
	 *
	 ...
	 */
	function lumen_allow_wp_kses_allowed_html( $tags, $context ) {
	...
	add_filter( 'wp_kses_allowed_html', 'lumen_allow_wp_kses_allowed_html', 10, 2 );
}
