 ...
 */
import { getShadows } from '~lumen/ui'
import { IMAGE_SHADOWS } from '~lumen/features'
...
export const useBlockLayoutInspectorUtils = ( storeName, optionName, setDisplayHoverNotice, saveTimeout ) => {
	...
	const onChange = ( property, _value, {
		...
		if ( currentHoverState !== 'normal' && ! unit ) {
			const disableHoverNotice = localStorage.getItem( 'lmn-disable-global-block-layouts-hover-notice' )
