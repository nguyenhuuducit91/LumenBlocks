...
if ( ! class_exists( 'Lumen_Global_Spacing_And_Borders' ) ) {

	/**
	 * Lumen Global Block Spacing and Borders
	 */
    class Lumen_Global_Spacing_And_Borders {
		 ...
		 */
  		function __construct() {
			...
			if ( lumen_is_frontend() ) {
				...
				add_filter( 'lumen_inline_styles_nodep', array( $this, 'add_global_spacing_and_borders_styles' ) );
			}
		}
		...
		public function add_global_spacing_and_borders_styles( $current_css ) {
			$generated_css = Lumen_Global_Settings::generate_global_block_layouts( 'lumen_global_spacing_and_borders', 'Global Spacing and Borders' );
		...
		public function add_body_class_spacing_and_borders( $classes ) {
			$classes[] = 'lmn-has-design-system-spacing-and-borders';
			return $classes;
		}
		...
		public function migrate_spacing_and_borders_schema_changes( $old_version, $new_version ) {
			...
			$option_name = 'lumen_global_spacing_and_borders';
	...
	new Lumen_Global_Spacing_And_Borders();
}
