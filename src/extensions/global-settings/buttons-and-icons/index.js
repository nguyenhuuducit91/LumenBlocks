...
import { BORDER_CONTROLS } from '~lumen/features'
...
addFilter( 'lumen.global-settings.inspector', 'lumen/global-buttons-and-icons', output => {
	...
	const [
		...
		'lumen/global-buttons-and-icons',
...
export const GlobalButtonsAndIconsStyles = () => {
	const styles = useBlockLayoutEditorLoader( 'lumen/global-buttons-and-icons', 'buttons-and-icons' )
