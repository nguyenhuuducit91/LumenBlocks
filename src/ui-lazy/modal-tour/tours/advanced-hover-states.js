	...
	steps: [
		{
			...
			anchor: '.lmn-control:has([data-attribute="containerBackgroundColor"])',
			position: 'left',
			glowTarget: '.lmn-control:has([data-attribute="containerBackgroundColor"]) .lmn-control-label button[data-value="normal"]',
			nextEventTarget: '.lmn-control:has([data-attribute="containerBackgroundColor"]) .lmn-control-label button',
			preStep: () => {
				setTimeout( () => {
					// Click the tab
					...
					setTimeout( () => {
						document.querySelector( '.lmb-panel--container:not(.is-opened) .lmn-panel' )?.click()
					}, 100 )
				}, 100 )
			},
		},
		{
			...
			anchor: '.lmn-control:has([data-attribute="containerBackgroundColor"]) .lmn-label-unit-toggle__wrapper button[data-value="hover"]',
			position: 'left',
			glowTarget: '.lmn-control:has([data-attribute="containerBackgroundColor"]) .lmn-label-unit-toggle__wrapper button[data-value="hover"]',
			nextEventTarget: '.lmn-control:has([data-attribute="containerBackgroundColor"]) .lmn-label-unit-toggle__wrapper button:not(.is-active)[data-value="hover"]',
			nextEvent: 'mousedown',
			preStep: () => {
				document.querySelector( '.lmn-control:has([data-attribute="containerBackgroundColor"]) .lmn-label-unit-toggle__wrapper:not(.is-open) button' )?.click()
			},
			postStep: () => {
				document.querySelector( '.lmn-control:has([data-attribute="containerBackgroundColor"]) .lmn-label-unit-toggle__wrapper button:not(.is-active)[data-value="hover"]' )?.click()
			},
		},
		{
			...
			anchor: '.lmn-control:has([data-attribute="containerBackgroundColor"])',
			position: 'left',
			glowTarget: '.lmn-control:has([data-attribute="containerBackgroundColor"]) .lmn-control-content',
			nextEventTarget: '.lmn-control-content[data-attribute="containerBackgroundColor"] button',
			preStep: () => {
				document.querySelector( '.lmn-control:has([data-attribute="containerBackgroundColor"]) .lmn-label-unit-toggle__wrapper button:not(.is-active)[data-value="hover"]' )?.click()
			},
			postStep: () => {
				document.querySelector( '.lmn-control-content[data-attribute="containerBackgroundColor"] button:not(.is-open)' )?.click()
			},
		},
		{
			...
			postStep: () => {
				...
				document.querySelector( '.lmn-control:has([data-attribute="containerBackgroundColor"]) .block-editor-panel-color-gradient-settings__dropdown.is-open' )?.click()
			},
		},
		{
		...
		},
		{
			...
			anchor: '.lmn-control:has([data-attribute="textColor1"]) .lmn-label-unit-toggle__wrapper button[data-value="parent-hover"]',
			position: 'left',
			glowTarget: '.lmn-control:has([data-attribute="textColor1"]) .lmn-label-unit-toggle__wrapper button[data-value="parent-hover"]',
			nextEventTarget: '.lmn-control:has([data-attribute="textColor1"]) .lmn-label-unit-toggle__wrapper button:not(.is-active)[data-value="parent-hover"]',
			nextEvent: 'mousedown',
			modalDelay: 150,
			preStep: () => {
				setTimeout( () => {
					const targetElTop = document.querySelector( '.lmn-control:has([data-attribute="textColor1"])' )?.getBoundingClientRect()?.top
					const editorSidebar = document.querySelector( '.editor-sidebar.lmb--has-panel-tabs' )
					...
					document.querySelector( '.lmn-control:has([data-attribute="textColor1"]) .lmn-label-unit-toggle__wrapper:not(.is-open) button' )?.click()
				}, 100 )
			},
			postStep: () => {
				document.querySelector( '.lmn-control:has([data-attribute="textColor1"]) .lmn-label-unit-toggle__wrapper:not(.is-open) button' )?.click()
				setTimeout( () => {
					document.querySelector( '.lmn-control:has([data-attribute="textColor1"]) .lmn-label-unit-toggle__wrapper button:not(.is-active)[data-value="parent-hover"]' )?.click()
				}, 100 )
			},
		},
		{
			...
			anchor: '.lmn-control:has([data-attribute="textColor1"])',
			position: 'left',
			glowTarget: '.lmn-control:has([data-attribute="textColor1"])',
			nextEventTarget: '.lmn-control:has([data-attribute="textColor1"]) .lmn-control-content button',
			preStep: () => {
				setTimeout( () => {
					const targetElTop = document.querySelector( '.lmn-control:has([data-attribute="textColor1"])' )?.getBoundingClientRect()?.top
					const editorSidebar = document.querySelector( '.editor-sidebar.lmb--has-panel-tabs' )
			...
			postStep: () => {
				document.querySelector( '.lmn-control-content[data-attribute="textColor1"] button:not(.is-open)' )?.click()
			},
		},
		{
			...
			postStep: () => {
				...
				document.querySelector( '.lmn-control:has([data-attribute="textColor1"]) .block-editor-panel-color-gradient-settings__dropdown.is-open' )?.click()
			},
		},
		{
		...
		},
		{
			...
			anchor: '.lmn-control:has([data-attribute="textColor1"]) .lmn-label-unit-toggle__wrapper button[data-value="normal"]',
			position: 'left',
			glowTarget: '.lmn-control:has([data-attribute="textColor1"]) .lmn-label-unit-toggle__wrapper button[data-value="normal"]',
			nextEventTarget: '.lmn-control:has([data-attribute="textColor1"]) .lmn-label-unit-toggle__wrapper button[data-value="normal"]',
			nextEvent: 'mousedown',
			preStep: () => {
				document.querySelector( '.lmn-control:has([data-attribute="textColor1"]) .lmn-label-unit-toggle__wrapper:not(.is-open) button' )?.click()
			},
			postStep: () => {
				document.querySelector( '.lmn-control:has([data-attribute="textColor1"]) .lmn-label-unit-toggle__wrapper:not(.is-open) button' )?.click()
				setTimeout( () => {
					document.querySelector( '.lmn-control:has([data-attribute="textColor1"]) .lmn-label-unit-toggle__wrapper button:not(.is-active)[data-value="normal"]' )?.click()
				}, 100 )
			},
		},
		{
