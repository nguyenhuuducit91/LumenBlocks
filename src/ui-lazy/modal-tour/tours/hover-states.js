...
export const hoverStates = {
	initialize: () => {
		...
		waitForElement( '.edit-post-sidebar__panel-tab.lmb-tab--style' ).then( () => {
			...
			setTimeout( () => {
				document.querySelector( '.lmb-panel--image:not(.is-opened)' )?.click()
				const target = document.querySelector( '.lmn-control:has([data-attribute="imageZoom"])' )
	...
	steps: [
		{
			...
			anchor: '.lmn-control:has([data-attribute="imageZoom"])',
			position: 'left',
			glowTarget: '.lmn-control:has([data-attribute="imageZoom"]) .lmn-control-label button[data-value="normal"]',
			nextEventTarget: '.lmn-control:has([data-attribute="imageZoom"]) .lmn-control-label button',
			preStep: () => {
				waitForElement( '.lmn-control:has([data-attribute="imageZoom"])', 3000 ).then( () => {
					const target = document.querySelector( '.lmn-control:has([data-attribute="imageZoom"])' )
					target?.scrollIntoView( { behavior: 'auto', block: 'center' } )
				} )
			},
		},
		{
			...
			anchor: '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle__wrapper',
			position: 'left',
			glowTarget: '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle__wrapper button[data-value="hover"]',
			nextEventTarget: '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle__wrapper button:not(.is-active)[data-value="hover"]',
			nextEvent: 'mousedown',
			preStep: () => {
				document.querySelector( '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle__wrapper:not(.is-open) button' )?.click()
			},
			postStep: () => {
				document.querySelector( '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle__wrapper button:not(.is-active)[data-value="hover"]' )?.click()
			},
		},
		{
			...
			anchor: '.lmn-control:has([data-attribute="imageZoom"])',
			position: 'left',
			glowTarget: '.lmn-control:has([data-attribute="imageZoom"]) .lmn-control-content',
			preStep: () => {
				document.querySelector( '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle__wrapper button:not(.is-active)[data-value="hover"]' )?.click()
			},
			postStep: () => {
				...
				const imageBlock = allBlocks.find( block => block.name === 'lumen/image' )
		...
		},
		{
			...
			anchor: '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle__wrapper button[data-value="normal"]',
			position: 'left',
			glowTarget: '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle__wrapper button[data-value="normal"]',
			nextEventTarget: '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle__wrapper button[data-value="normal"]',
			nextEvent: 'mousedown',
			preStep: () => {
				document.querySelector( '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle__wrapper:not(.is-open) button' )?.click()
			},
			postStep: () => {
				document.querySelector( '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle__wrapper:not(.is-open) button' )?.click()
				waitForElement( '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle__wrapper button[data-value="normal"]' ).then( () => {
					document.querySelector( '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle__wrapper button:not(.is-active)[data-value="normal"]' )?.click()
				} )
			},
		},
		{
			...
			anchor: '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle',
			position: 'left',
			glowTarget: '.lmn-control:has([data-attribute="imageZoom"]) .lmn-label-unit-toggle',
		},
		{
		...
		},
		{
			...
			anchor: '.lmn-control:has([data-attribute="imageShadow"])',
			position: 'left',
			glowTarget: '.lmn-control:has([data-attribute="imageShadow"])',
		},
	],
}
