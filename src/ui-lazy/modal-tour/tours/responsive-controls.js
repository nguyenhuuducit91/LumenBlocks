	...
	steps: [
		{
			...
			anchor: '.lmb-sort-control',
			position: 'left',
			glowTarget: '.lmb-sort-control.components-base-control .lmn-control-responsive-toggle',
			nextEventTarget: '.lmb-sort-control.components-base-control .lmn-control-responsive-toggle button',
			preStep: async () => {
				...
				await waitForElement( '.edit-post-sidebar__panel-tab.lmb-tab--layout' )
				// Open Layout tab if it's not open
				document.querySelector( '.edit-post-sidebar__panel-tab.lmb-tab--layout:not(.is-active)' )?.click()

				await waitForElement( '.lmb-panel--layout' )
				document.querySelector( '.lmb-panel--layout:not(.is-opened)' )?.click()
			},
			postStep: () => {
				document.querySelector( '.lmb-sort-control .lmn-control-responsive-toggle:not(.is-open) button' )?.click()
			},
		},
		{
			...
			anchor: '.lmb-sort-control .lmn-control-responsive-toggle',
			position: 'left',
			glowTarget: '.lmb-sort-control.components-base-control .lmn-control-responsive-toggle .lmn-label-unit-toggle__wrapper',
			nextEventTarget: '.lmb-sort-control .lmn-control-responsive-toggle.is-open button[aria-label="Mobile"]',
			nextEvent: 'mousedown',
			preStep: () => {
				document.querySelector( '.lmb-sort-control .lmn-control-responsive-toggle:not(.is-open) button' )?.click()
			},
			postStep: () => {
				document.querySelector( '.lmb-sort-control .lmn-control-responsive-toggle button:not(.is-active)[data-value="mobile"]' )?.click()
			},
		},
		{
		...
		},
		{
			...
			anchor: '.lmb-sort-control .lmn-control-content',
			position: 'left',
			glowTarget: '.lmb-sort-control .lmn-control-content .lmb-sort-control__container',
			postStep: () => {
		...
		},
		{
			...
			anchor: '.lmb-sort-control .lmn-control-responsive-toggle button[data-value="desktop"]',
			position: 'left',
			glowTarget: '.lmb-sort-control .lmn-control-responsive-toggle button[data-value="desktop"]',
			nextEventTarget: '.lmb-sort-control .lmn-control-responsive-toggle button[data-value="desktop"]',
			nextEvent: 'mousedown',
			preStep: () => {
				document.querySelector( '.lmb-sort-control .lmn-control-responsive-toggle:not(.is-open) button' )?.click()
			},
			postStep: async () => {
				...
				await waitForElement( '.lmb-sort-control .lmn-control-responsive-toggle button[data-value="desktop"]' )
				document.querySelector( '.lmb-sort-control .lmn-control-responsive-toggle button:not(.is-active)[data-value="desktop"]' )?.click()
			},
		},
		{
