...
export const designSystem = {
	steps: [
		...
		},
		{
			...
			anchor: '.lmb-global-settings__preview-button',
			position: 'left',
			nextEventTarget: '.lmb-global-settings__preview-button',
			glowTarget: '.lmb-global-settings__preview-button',
			postStep: () => {
				// Open the style guide if it's not open.
				if ( ! document.querySelector( '.lmb-style-guide-popover' ) ) {
					document.querySelector( '.lmb-global-settings__preview-button' )?.click()
				}
			},
		},
		{
			...
			size: 'medium',
			anchor: '.lmb-style-guide-popover > .components-popover__content',
			position: 'center',
			// glowTarget: '.interface-interface-skeleton__sidebar',
		},
		{
			...
			anchor: '.lmb-global-typography__panel .components-panel__body-title',
			position: 'left',
			glowTarget: '.lmb-global-typography__panel .components-panel__body-toggle',
			nextEventTarget: '.lmb-global-typography__panel .components-panel__body-toggle',
			skipIf: () => {
				return document.querySelector( '.lmb-global-typography__panel' )?.classList.contains( 'is-opened' )
			},
			postStep: () => {
				// Open the typography panel if it's not open.
				if ( document.querySelector( '.lmb-global-typography__panel:not(.is-opened)' ) ) {
					document.querySelector( '.lmb-global-typography__panel .components-panel__body-toggle' )?.click()
				}
			},
		},
		{
			...
			anchor: '.lmb-global-settings-font-pair-control:not(.lmb-global-settings-font-pair__selected)',
			position: 'left',
			glowTarget: '.lmb-global-settings-font-pair-control:not(.lmb-global-settings-font-pair__selected)',
			nextEventTarget: '.lmb-global-settings-font-pair__container [role="button"]',
			preStep: () => {
				// Make sure that the typography panel is open.
				if ( document.querySelector( '.lmb-global-typography__panel:not(.is-opened)' ) ) {
					document.querySelector( '.lmb-global-typography__panel .components-panel__body-title' )?.click()
				}
				const el = document.querySelector( '.lmb-global-settings-font-pair__container' )
				if ( el ) {
		...
		},
		{
			...
			anchor: '.lmb-style-guide__color-container',
			position: 'top',
			glowTarget: '.lmb-style-guide__color-container',
			preStep: () => {
				const el = document.querySelector( '.lmb-style-guide-popover > .components-popover__content' )
				// Scroll this to the top.
				if ( el ) {
					el.scrollTo( {
						top: 0,
		...
		},
		{
			...
			anchor: '.lmb-style-guide__print-button',
			position: 'bottom',
			glowTarget: '.lmb-style-guide__print-button',
			preStep: () => {
				const el = document.querySelector( '.lmb-style-guide-popover > .components-popover__content' )
				// Scroll this to the top.
				if ( el ) {
		...
		},
		{
			...
			anchor: '.lmb-style-guide-popover__close-button',
			position: 'bottom',
			glowTarget: '.lmb-style-guide-popover__close-button',
			nextEventTarget: '.lmb-style-guide-popover__close-button',
			postStep: () => {
				document.querySelector( '.lmb-style-guide-popover__close-button' )?.click()
			},
		},
	],
}
