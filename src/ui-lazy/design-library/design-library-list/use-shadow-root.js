import { wpGlobalStylesInlineCss } from 'lumen'
...
export const useShadowRoot = shouldRender => {
	...
	const STYLE_IDS = applyFilters( 'lumen.global-styles.ids', [
		'lmb-dep-native-global-style-css-nodep-inline-css',
		'lmb-style-css-css',
		'lmb-style-css-responsive-css',
		'lmb-block-style-inheritance-nodep-inline-css',
		'lmb-style-css-premium-css',
	] )
	...
	useEffect( () => {
	  if ( shouldRender && hostRef.current ) {
			...
			if ( ! existingIds.has( 'lmn-design-library-styles' ) ) {
				const hostStyles = document.createElement( 'style' )
				hostStyles.setAttribute( 'id', 'lmn-design-library-styles' )
