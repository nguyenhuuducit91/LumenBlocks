...
const renderSectionTitle = section => {
	return <div className="lmb--autosuggest-group">{ section.title }</div>
}
	...
	render() {
		...
		return (
			<BaseControl
				...
				className={ classnames( 'lmb-advanced-autosuggest-control', this.props.className ) }
			...
			>
				<div className="lmb-advanced-autosuggest-control__select" ref={ this.autosuggestDiv }>
					...
					<Autosuggest
						...
						renderSuggestion={ suggestion => {
							return <div
								className="lmb-autosuggest-option"
								data-value={ suggestion.value }
								id={ `lmb-autosuggest-option--${ suggestion.id || kebabCase( suggestion.value ) }` }
							>
							...
							if ( shouldShowSuggestions && this.state.containerRect ) {
								...
								const suggestions = (
									<div
										{ ...containerProps }
										style={ style }
										className={ classnames( containerProps.className, 'lmb-advanced-autosuggest__suggestions-container' ) }
									>
										{ children }
									</div>
								)
					...
					/>
					{ this.state.isEmpty && <div className="lmb--autosuggest-empty">{ this.props.noMatchesLabel }</div> }
					{ this.props.children }
				</div>
			</BaseControl>
		)
