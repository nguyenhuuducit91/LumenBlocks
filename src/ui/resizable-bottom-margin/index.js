...
const ResizableBottomMarginSingle = props => {
	...
	const defaultBottomMargin = applyFilters( 'lumen.resizable-bottom-margin.default', DEFAULT_BOTTOM_MARGINS[ deviceType ], name )

	const classNames = classnames( [
		'lmn-resizable-bottom-margin',
	], {
		'lmn--is-resizing': currentHeight !== null,
		'lmn--is-tiny': ( props.value !== '' ? props.value : defaultBottomMargin ) < 5,
	} )
	...
	return (
		...
		>
			...
			<span className="lmn-resizable-bottom-margin__label">
...
ResizableBottomMargin.defaultProps = {
	previewSelector: '', // Selector of the element where the margin is applied e.g. .lmn-card-group
	attribute: '',
	responsive: false,
}
