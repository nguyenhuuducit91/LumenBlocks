 ...
 */
import { useBlockAttributesContext, useDeviceType } from '~lumen/hooks'
...
import { isEmptyAttributes } from '~lumen/utils'
...
const ResponsiveToggle = props => {
	...
	const changeScreen = screen => {
		...
		if ( dispatch( 'core/edit-site' ) && dispatch( 'core/edit-site' ).__experimentalSetPreviewDeviceType ) {
			...
			dispatch( 'lumen/device-type' ).setDeviceType( DEVICE_TYPES[ screen ] )
		}
	}
	...
	return (
		<ControlIconToggle
			className="lmn-control-responsive-toggle"
