...
import { getEditorStylesOnly, generateStyles } from '~lumen/features/style'
...
const Style = memo( props => {
	...
	const uniqueId = _blockUniqueClassName?.replace( 'lmn-', '' ) || ''
...
Style.defaultProps = {
	...
	versionDeprecated: false, // The version of Lumen when this style wasn't used anymore.
}
