...
const IconControl = props => {
	return (
		<BaseControl
			className="lmb-icon-control lmn-control"
		...
		>
			<div className="lmb-icon-control__wrapper">
				<div className="lmb-icon-control__button-wrapper">
					<Dropdown
						...
						renderToggle={ ( { onToggle, isOpen } ) => (
							<Button
								isSecondary
								onClick={ onToggle }
								className="lmb-icon-control__icon-button"
