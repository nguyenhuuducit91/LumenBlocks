...
// Initial layouts.
addFilter( 'lumen.separator.edit.layouts', 'default', layouts => {
	return uniqBy( [
		...layouts,
		...designs,
	], 'value' )
...
const DesignSeparatorControl = props => {
	...
	const options = ( applyFilters( 'lumen.separator.edit.layouts', [] ) || [] )
		.filter( layouts =>
	...
	return (
		<BaseControl
			className="lmb-design-separator-control"
			id="lmb-design-separator-control"
			label={ label }
			help={ help }
