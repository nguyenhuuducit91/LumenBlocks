 ...
 */
import { BaseControlMultiLabel } from '~lumen/ui'
...
const ImageControl = props => {
	...
	return (
		<div className="lmb-image-control">
							...
							<Fragment>
								{ props.imageURL &&
									<div className="lmb-image-preview-wrapper">
										<button className="lmb-image-preview-remove" onClick={ onRemove }>
											<Dashicon icon="no" />
										</button>
										{ type === 'video' && (
											<video
