...
class FourNumberControl extends Component {
	...
	render() {
		...
		const id = `lmb-four-number-control-${ instanceId }__item-`

		return (
			<BaseControl
				help={ this.props.help }
				className={ classnames( 'lmb-four-number-control', this.props.className ) }
			...
			>
				...
				/>
				<div className="lmb-four-number-control__wrapper">
					<label className="lmb-four-number-control__label" htmlFor={ `${ id }-top` }>
						<input
							id={ `${ id }-top` }
							type="number"
					...
					<label className="lmb-four-number-control__label" htmlFor={ `${ id }-right` }>
						<input
							id={ `${ id }-right` }
							type="number"
					...
					<label className="lmb-four-number-control__label" htmlFor={ `${ id }-bottom` }>
						<input
							id={ `${ id }-bottom` }
							type="number"
					...
					<label className="lmb-four-number-control__label" htmlFor={ `${ id }-left` }>
						<input
							id={ `${ id }-left` }
							type="number"
					...
					<Button
						className={ this.state.locked ? 'lmb--is-locked' : '' }
