...
const AdminToolbarSetting = props => {
	return (
		<AdminBaseSetting
			...
			showLabel={ false }
		>
			<div className="lmb-admin-toolbar-setting__wrapper">
				<h3>{ props.label }</h3>
				{ props.demoLink && (
					<a
						href={ props.demoLink }
				...
				<div className="lmb-admin-toolbar-setting__group-wrapper">
					<ButtonGroup
						children={
							props.controls.map( option => {
								...
								return <Button
									...
									children={ <span className="lmb-admin-toolbar-setting__option">{ option.title }</span> }
								/>
							} )
						}
						className="lmb-admin-toolbar-setting"
					/>
				</div>
			</div>
		</AdminBaseSetting>
