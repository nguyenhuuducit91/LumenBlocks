...
const AdminToggleSetting = props => {
	...
	return (
		<AdminBaseSetting
			...
			{ ...props }
			className={ classnames( props.className, 'lmb-admin-toggle-setting' ) }
		>
			<button
				ref={ ref }
				className={ classnames(
					'lmb-admin-toggle-setting__button',
					{ 'lmb-admin-toggle-setting__button--enabled': !! props.value }
				) }
				type="button"
				role="switch"
			...
			<span className="lmb-admin-toggle-setting__label">
