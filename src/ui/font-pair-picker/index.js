 ...
 */
import { BaseControl, Button } from '~lumen/ui'
...
const FontPairPicker = props => {
	...
	const label = (
		<div>
			<span
				...
				className="lmb-global-settings-font-pair__label"
			>
			...
			<span
				...
				className="lmb-global-settings-font-pair__sub-label"
			>
	...
	const classes = classNames( [
		...
		'lmb-global-settings-font-pair-control',
		{ 'lmb-global-settings-font-pair__selected': props?.isSelected },
	] )
