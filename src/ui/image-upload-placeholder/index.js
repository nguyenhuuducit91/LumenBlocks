...
const ImageUploadPlaceholder = props => {
	...
	const imageClass = classnames( [
		className,
		'lmb-image-upload-placeholder',
	], {
		'lmb-image-upload-has-image': imageURL,
		'lmb-image-upload-has-placeholder': ! imageURL,
	} )
					...
					return (
						...
						>
							{ imageURL && onRemove && hasRemove && (
								<button className="lmb-image-upload-remove" onClick={ ev => {
