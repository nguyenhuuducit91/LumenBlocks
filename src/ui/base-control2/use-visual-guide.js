...
import { useVisualGuideContext } from '~lumen/hoc/with-visual-guide'
...
export const VisualGuideer = props => {
	...
	return (
		<div
			className="lmn-visual-guideer-trigger"
			onMouseEnter={ () => {
				...
				if ( document?.activeElement?.getAttribute( 'data-type' )?.startsWith( 'lumen/' ) ) { //
					// eslint-disable-next-line @wordpress/no-global-active-element
