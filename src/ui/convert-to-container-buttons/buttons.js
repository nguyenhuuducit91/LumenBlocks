/**
 * Based on: https://github.com/WordPress/gutenberg/blob/master/packages/editor/src/ui/convert-to-group-buttons/convert-button.js
 */
...
export default compose( [
	withSelect( ( select, { clientIds } ) => {
		...
		const groupingBlockName = 'lmb/container'
	...
	withDispatch( ( dispatch, {
		...
		return {
			onConvertToGroup() {
				...
				const containerBlock = createBlock( 'lmb/container', {}, innerBlocks )
