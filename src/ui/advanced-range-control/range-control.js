...
const LumenRangeControl = memo( props => {
	const {
		allowReset,
		withInputField,
		isShiftStepEnabled,
	...
	return <div
		...
		style={ { '--lmb-advanced-range-control--width': percentageValue } }
	>
		<RangeControl
			{ ...propsToPass }
			value={ value }
...
LumenRangeControl.defaultProps = {
	className: '',
	allowReset: false,
	withInputField: true,
...
export default LumenRangeControl
