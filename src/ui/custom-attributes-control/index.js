...
const CustomAttributesControl = props => {
	...
	return (
		<AdvancedTextControl
			...
			className="lmb-custom-attributes-control"
			...
			help={ (
				<Fragment>
					...
					{ hasError && <span className="lmb-custom-attributes-control__error">{ __( 'There is an error in your custom attribute', i18n ) }</span> }
				</Fragment>
			) }
		/>
	)
