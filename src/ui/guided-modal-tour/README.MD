...
`src/extensions/guided-modal-tour/index.js`
...
Create the tour steps in `src/ui-lazy/modal-tour/tours/`, refer to
`src/ui-lazy/modal-tour/tours/README.md` for more details
