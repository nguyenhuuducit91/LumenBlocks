...
This auto-fixes invalid Lumen blocks when the editor initializes.
...
This measure is implemented because Lumen blocks have a large number of
...
the block updates, but due to the complexity of Lumen blocks (and that most
