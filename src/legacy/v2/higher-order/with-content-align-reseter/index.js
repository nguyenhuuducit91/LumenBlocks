 ...
 */
import { getAttrName } from '~lumen/utils'
...
const withContentAlignReseter = ( attributeNamesToReset = [] ) => createHigherOrderComponent(
	WrappedComponent => class extends Component {
		...
		componentDidMount() {
			...
			addFilter( `lumen.${ blockName }.setAttributes`, `lumen/${ blockName }/contentAlign`, attributes => {
				const screens = [ '', 'Tablet', 'Mobile' ]
				const resetAlignments = applyFilters( 'lumen.with-content-align-reseter.attributeNamesToReset', attributeNamesToReset, blockName )
