 ...
 *
 * @param {Array} matchers An array of mathcer arrays. For example [ [ 'lmb-cta__title', 'title' ] ]
 *                         This will listen for clicks on the element that has the class `lmb-cta__title`
