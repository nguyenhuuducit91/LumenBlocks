...
export const addNewAlignFunctionality = blockName => {
	addFilter( `lumen.${ blockName }.settings`, `lumen/${ blockName }/block-background`, removeAlignSupport, 99 )
	blocksWithBlockBackgroundModule.push( `lmb/${ blockName }` )
}
...
addFilter( 'editor.BlockListBlock', 'lumen/with-data-align', withDataAlign )
addFilter( 'blocks.getSaveContent.extraProps', 'lumen/addAssignedAlign', addAssignedAlign )
