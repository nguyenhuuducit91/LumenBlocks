...
const addAttributes = attributes => ( {
	...
	...createContainerLinkAttributes( 'container1%s', {
		selector: '.lmb-container-link:nth-child(1) > a',
	} ),
	...createContainerLinkAttributes( 'container2%s', {
		selector: '.lmb-container-link:nth-child(2) > a',
	} ),
	...createContainerLinkAttributes( 'container3%s', {
		selector: '.lmb-container-link:nth-child(3) > a',
	} ),
	...createContainerLinkAttributes( 'container4%s', {
		selector: '.lmb-container-link:nth-child(4) > a',
	} ),
} )
...
const addItemClasses = ( classes, props ) => {
	...
	return {
		...classes,
		'lmb-container-link': showContainerLink,
	}
}
...
const addBoxClasses = ( classes, props1, props2 ) => {
	...
	return {
		...classes,
		'lmb-container-link': showContainerLink || false,
	}
}
...
const containerLink = ( blockName, options = {} ) => {
	...
	addFilter( `lumen.${ blockName }.edit.inspector.style.block`, `lumen/${ blockName }/container-link`, addInspectorPanel, 18 )
	addFilter( `lumen.${ blockName }.attributes`, `lumen/${ blockName }/container-link`, addAttributes )
	addFilter( `lumen.${ blockName }.design.filtered-block-attributes`, `lumen/${ blockName }/container-link`, removeAttributesFromDesignAttributeExport )
	...
	if ( classFilter ) {
		addFilter( `lumen.${ blockName }.${ classFilter }`, `lumen/${ blockName }/container-link`, addItemClasses )
	} else {
		addFilter( `lumen.${ blockName }.itemclasses`, `lumen/${ blockName }/container-link`, addItemClasses )
		addFilter( `lumen.${ blockName }.boxclasses`, `lumen/${ blockName }/container-link`, addBoxClasses )
	}
}
