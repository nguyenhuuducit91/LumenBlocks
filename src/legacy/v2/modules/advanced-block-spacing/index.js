...
removeFilter( 'lumen.setAttributes', 'lumen/module/block-spacing' )
addFilter( 'lumen.setAttributes', 'lumen/module/block-spacing', ( attributes, blockProps ) => {
	...
	return (
		<Fragment>
			...
			<PanelAdvancedSettings
				...
				initialOpen={ false }
				className="lmb--help-tip-advanced-block-spacing"
			>
				{ applyFilters( `lumen.${ blockName }.edit.advanced.block-spacing.before`, null, props ) }
				...
				{ options.height && <Fragment>
					<WhenResponsiveScreen>
						<AdvancedRangeControl
							...
							placeholder="0"
							className="lmb--help-tip-advanced-block-height"
						/>
					</WhenResponsiveScreen>
						...
						{ blockHeight !== '' &&
							<WhenResponsiveScreen>
								<AdvancedToolbarControl
									...
									className="lmb--help-tip-advanced-block-vertical-align"
								/>
							</WhenResponsiveScreen>
						}
						{ tabletBlockHeight !== '' &&
				...
				{ options.width && <Fragment>
					<WhenResponsiveScreen>
						<AdvancedRangeControl
							...
							className="lmb--help-tip-advanced-block-content-width"
						/>
					</WhenResponsiveScreen>
					<WhenResponsiveScreen screen="tablet">
						<AdvancedRangeControl
						...
						{ ( blockWidth !== '' || ( blockInnerWidth !== '' && blockInnerWidth !== 'full' ) ) &&
							<WhenResponsiveScreen>
								<AdvancedToolbarControl
									...
									className="lmb--help-tip-advanced-block-horizontal-align"
								/>
							</WhenResponsiveScreen>
						}
				...
				{ options.margins && <Fragment>
					<WhenResponsiveScreen screen="desktop">
						<FourRangeControl
							...
							className="lmb--help-tip-advanced-block-margins"
						/>
					</WhenResponsiveScreen>
					<WhenResponsiveScreen screen="tablet">
						<FourRangeControl
				...
				{ options.paddings && <Fragment>
					<WhenResponsiveScreen screen="desktop">
						<FourRangeControl
							...
							placeholder="0"
							className="lmb--help-tip-advanced-block-paddings"
						/>
					</WhenResponsiveScreen>
					<WhenResponsiveScreen screen="tablet">
						<FourRangeControl
				...
				{ applyFilters( `lumen.${ blockName }.edit.advanced.block-spacing.after`, null, props ) }
			</PanelAdvancedSettings>
		</Fragment>
	)
}
...
const addToStyleObject = blockName => ( styleObject, props ) => {
	...
	const margins = applyFilters( `lumen.${ blockName }.advanced-block-spacing.margins`, {
		desktopTablet: {
	...
	const paddings = applyFilters( `lumen.${ blockName }.advanced-block-spacing.paddings`, {
		desktopTablet: {
			[ blockClass ]: appendImportantAll( {
...
const addCustomWidthClassName = ( mainClasses, props ) => {
	...
	return {
		...mainClasses,
		'lmb--has-custom-content-width': blockWidth !== '',
		'lmb--has-custom-content-width-tablet': tabletBlockWidth !== '',
		'lmb--has-custom-content-width-mobile': mobileBlockWidth !== '',
	}
}
...
const advancedBlockSpacing = ( blockName, options = {} ) => {
	...
	addFilter( `lumen.${ blockName }.edit.inspector.advanced.before`, `lumen/${ blockName }/advanced-block-spacing`, inspectorControls( blockName, optionsToPass ), 5 )
	if ( optionsToPass.modifyStyles ) {
		addFilter( `lumen.${ blockName }.styles`, `lumen/${ blockName }/advanced-block-spacing`, addToStyleObject( blockName, optionsToPass ) )
	}
	addFilter( `lumen.${ blockName }.attributes`, `lumen/${ blockName }/advanced-block-spacing`, addAttributes )
	addFilter( `lumen.${ blockName }.main-block.classes`, `lumen/${ blockName }/advanced-block-spacing`, addCustomWidthClassName )
	doAction( `lumen.module.advanced-block-spacing`, blockName )
}
