...
const advancedCustomAttributes = ( blockName, options = {} ) => {
	...
	addFilter( `lumen.${ blockName }.attributes`, `lumen/${ blockName }/advanced-custom-attributes`, addAttributes )
	addFilter( `lumen.${ blockName }.edit.inspector.advanced.before`, `lumen/${ blockName }/advanced-custom-attributes`, addInspectorControls )
	addFilter( `lumen.${ blockName }.main-block.extraProps`, `lumen/${ blockName }/advanced-custom-attributes`, createAddSaveProps )
}
