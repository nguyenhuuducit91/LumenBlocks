	...
	return (
		<Fragment>
			...
			<PanelAdvancedSettings
				...
				id="block-title"
				className="lmb-panel-block-title-module"
...
const addAttributes = attributes => {
	return {
		...
		blockDescription: {
			source: 'html',
			selector: '.lmb-block-description',
...
const addTitleEditOutput = ( output, design, props ) => {
	...
	const titleClasses = classnames( [
		...
		'lmb-block-title--with-subtitle': showBlockDescription && blockDescription,
	} )
		...
		<Fragment>
			...
			{ showBlockDescription && (
				<RichText
					...
					className="lmb-block-description"
			...
			{ showBlockTitle && (
				...
				>
					<AdvancedRangeControl
						...
						placeholder="16"
						allowReset={ true }
						className="lmb--help-tip-spacing-block-title"
					/>
				</ResponsiveControl>
			) }
			{ showBlockDescription && (
				...
				>
					<AdvancedRangeControl
						...
						placeholder="50"
						allowReset={ true }
						className="lmb--help-tip-spacing-block-description"
					/>
				</ResponsiveControl>
			) }
		</Fragment>
...
const blockTitle = ( blockName, options = {} ) => {
	...
	removeFilter( 'lumen.panel-spacing-body.edit.before', 'lumen/block-title' )
	addFilter( `lumen.${ blockName }.edit.inspector.style.block`, `lumen/${ blockName }/block-title`, addInspectorPanel, 17 )
	addFilter( `lumen.${ blockName }.attributes`, `lumen/${ blockName }/block-title`, addAttributes )
	addFilter( 'lumen.panel-spacing-body.edit.before', 'lumen/block-title', addTitleSpacing )
	addFilter( `lumen.${ blockName }.edit.output.before`, `lumen/${ blockName }/block-title`, addTitleEditOutput )
	addFilter( `lumen.${ blockName }.save.output.before`, `lumen/${ blockName }/block-title`, addTitleSaveOutput )
	addFilter( `lumen.${ blockName }.styles`, `lumen/${ blockName }/block-title`, addStyles( optionsToPass ) )
	addFilter( 'lumen.with-content-align-reseter.attributeNamesToReset', `lumen/${ blockName }/block-title`, centerBlockTitle )
	addFilter( `lumen.${ blockName }.design.filtered-block-attributes`, `lumen/${ blockName }/block-title`, removeAttributesFromDesignAttributeExport )
	doAction( `lumen.module.block-title`, blockName )
}
