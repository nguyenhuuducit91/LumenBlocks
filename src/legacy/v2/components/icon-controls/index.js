...
const IconControls = props => {
	...
	return (
		<Fragment>
			...
			{ props.onChangeDesign &&
				<DesignControl
					...
					options={ [
						...
						...applyFilters( 'lumen.icon-controls.edit.layouts', [] ),
					] }
			...
			{ applyFilters( 'lumen.icon-controls.edit.color', ( () => {
				return (
					<Fragment>
						{ props.onChangeColor &&
							<ColorPaletteControl
			...
			{ showBackground && props.onChangeBackgroundColor &&
				<Fragment>
					...
					{ applyFilters( 'lumen.icon-controls.edit.background-color', ( () => {
						return (
							<Fragment>
			...
			{ applyFilters( 'lumen.icon-controls.edit.after', null, props ) }
