...
Use the helper functions in `@lumen/util/typography` in conjuction with this.

Adds the `TypographyControl` in a quicker way:

```js
import { TypographyControlHelper } from '@lumen/components'
...
```js
import { TypographyControl } from '@lumen/components'
