...
import { getDesigns, setDevModeDesignLibrary } from '~lumen/design-library'
import {
	i18n, isPro, devMode,
} from 'lumen'
...
const ModalDesignLibrary = props => {
	...
	const [ isDevMode, setIsDevMode ] = useLocalStorage( 'lmn__design_library_dev_mode', false )
	...
	useEffect( () => {
		const input = document.querySelector( '.lmb-modal-design-library__search input' )
		if ( input ) {
			input.focus()
		}
	}, [] )
	...
	return (
		<Modal
			...
			className="lmb-modal-design-library"
			onRequestClose={ props.onClose }
		>
			<div className="lmb-modal-design-library__wrapper">
				<aside className="lmb-modal-design-library__sidebar">
					<TextControl
						className="lmb-modal-design-library__search"
				...
				<aside className="lmb-modal-design-library__topbar">
					{ devMode &&
						<ToggleControl
							className="lmb-modal-design-library__dev-mode"
							label="Dev Mode"
							checked={ isDevMode }
							onChange={ value => {
				...
				<div className="lmb-modal-design-library__designs">
					<DesignLibraryList
						columns={ columns }
