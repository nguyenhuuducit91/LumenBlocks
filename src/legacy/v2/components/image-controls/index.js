...
import { getImageSize, cacheImageData } from '~lumen/utils'
		...
		<Fragment>
				...
				<Fragment>
					<WhenResponsiveScreen>
						<AdvancedRangeControl
							...
							allowReset={ true }
							className="lmb--help-tip-image-size-no-crop"
						/>
					</WhenResponsiveScreen>
					...
					{ ( typeof props.width === 'number' || props.width ) &&
						<WhenResponsiveScreen>
							<AdvancedToggleControl
								...
								className="lmb--help-tip-image-square"
							/>
						</WhenResponsiveScreen>
					}
			...
			{ props.onChangeBorderRadius && props.shape === '' &&
				<AdvancedRangeControl
					...
					allowReset={ true }
					placeholder="0"
					className="lmb--help-tip-image-border-radius"
				/>
			}
			...
			{ props.onChangeShadow && props.shape === '' &&
				<AdvancedRangeControl
					...
					allowReset={ true }
					placeholder="0"
					className="lmb--help-tip-image-shadow"
				/>
			}
