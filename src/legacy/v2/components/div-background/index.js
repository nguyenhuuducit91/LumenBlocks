...
const DivBackground = props => {
	...
	const divClasses = classnames( [
		...
		'lmb--has-background-overlay': showBackground && hasBackgroundOverlay( backgroundAttrName, blockProps.attributes ),
	} )
	...
	return (
		<BlockTag className={ divClasses } { ...omit( propsToPass, 'index' ) }>
			...
			{ applyFilters( 'lumen.div-background.output.after', null, props, blockProps ) }
		</BlockTag>
	)
}
