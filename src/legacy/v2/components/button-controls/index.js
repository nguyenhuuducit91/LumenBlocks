...
const ButtonControls = props => {
	...
	return (
		<Fragment>
			<div className="lmn-button-controls__wrapper">
				{ props.onChangeUrl && (
					<URLInputControl
			...
			{ props.onChangeDesign && (
				<DesignControl
					...
					options={ [
						...
						...applyFilters( 'lumen.button-controls.layouts', [] ),
					] }
				...
				<Fragment>
					{ props.onChangeBackgroundColorType && showGradient && (
						<BaseControl
							...
							className="lmb--help-tip-button-color-type"
						>
							<AdvancedToolbarControl
								controls={ [
									{
					...
					{ props.onChangeBackgroundColor2 && props.backgroundColorType === 'gradient' && showGradient && (
						<AdvancedRangeControl
							...
							allowReset={ true }
							placeholder="90"
							className="lmb--help-tip-gradient-direction"
						/>
					) }
			...
			{ props.onChangeHoverGhostToNormal && design === 'ghost' && (
				<AdvancedToggleControl
					...
					className="lmb--help-tip-button-to-normal"
				/>
			) }
			...
			{ props.onChangeHoverEffect && design !== 'link' && (
				<AdvancedSelectControl
					...
					className="lmb--help-tip-button-hover-effect"
				/>
			) }
			...
			{ props.onChangeOpacity && (
				<AdvancedRangeControl
					...
					placeholder="0.8"
					allowReset={ true }
					className="lmb--help-tip-button-hover-opacity"
				/>
			) }
			...
			{ props.hasHoverColors && design !== 'link' && ( ! props.onChangeUseSocialColors || ! props.useSocialColors ) && (
				<ButtonIconPopoverControl
					...
					className="lmb--help-tip-button-hover-color"
				>
			...
			{ props.onChangeSize && ( props.onChangeDesign ? design !== 'link' : true ) &&
				<AdvancedSelectControl
					...
					className="lmb--help-tip-button-size"
				/>
			}
			...
			{ props.onChangePaddings && design !== 'link' && design !== 'plain' &&
				<FourRangeControl
					...
					enableRight={ false }
					placeholder={ 8 }
					className="lmb--help-tip-button-vertical-padding"
				/>
			}
			{ props.onChangePaddings && design !== 'link' && design !== 'plain' &&
				<FourRangeControl
					...
					max={ 100 }
					placeholder={ 26 }
					className="lmb--help-tip-button-horizontal-padding"
				/>
			}
			...
			{ props.onChangeShadow && ( design === '' || design === 'basic' ) &&
				<AdvancedRangeControl
					...
					allowReset={ true }
					placeholder="0"
					className="lmb--help-tip-button-shadow"
				/>
			}
