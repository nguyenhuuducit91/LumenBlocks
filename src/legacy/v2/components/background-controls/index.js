	...
	return (
		<Fragment>
			{ props.onChangeBackgroundColorType && (
				<BaseControl
					id="lmb-background-color-type"
					className="lmb--help-tip-background-color-type"
				>
					<AdvancedToolbarControl
						controls={ [
							{
				...
				>
					...
					{ props.onChangeBackgroundGradientLocation1 && (
						<AdvancedRangeControl
							...
							allowReset={ true }
							placeholder="0"
							className="lmb--help-tip-gradient-location"
						/>
					) }
					...
					{ props.onChangeBackgroundGradientBlendMode && (
						<BlendModeControl
							...
							className="lmb--help-tip-background-blend-mode"
						/>
					) }
				</ButtonIconPopoverControl>
			}
			...
			{ props.onChangeBackgroundTintStrength && props.onChangeBackgroundMedia &&
				...
				<AdvancedRangeControl
						...
						className="lmb--help-tip-background-tint"
				/>
			) }
			...
			{ props.onChangeFixedBackground && props.onChangeBackgroundMedia &&
				...
				<AdvancedToggleControl
						...
						className="lmb--help-tip-background-fixed"
				/>
			) }
					...
					>
						...
						<WhenResponsiveScreen>
							<AdvancedSelectControl
								...
								className="lmb--help-tip-background-image-position"
							/>
						</WhenResponsiveScreen>
						<WhenResponsiveScreen screen="tablet">
							<AdvancedSelectControl
						...
						<WhenResponsiveScreen>
							<AdvancedSelectControl
								...
								className="lmb--help-tip-background-image-repeat"
							/>
						</WhenResponsiveScreen>
						<WhenResponsiveScreen screen="tablet">
							<AdvancedSelectControl
						...
						<WhenResponsiveScreen>
							<AdvancedSelectControl
								...
								className="lmb--help-tip-background-image-size"
							/>
						</WhenResponsiveScreen>
						<WhenResponsiveScreen screen="tablet">
							<AdvancedSelectControl
