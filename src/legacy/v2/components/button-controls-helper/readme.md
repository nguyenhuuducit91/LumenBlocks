...
Use the helper functions in `@lumen/util/button` in conjuction with this.

Adds the `ButtonControls` in a quicker way:

```js
import { ButtonControlsHelper } from '@lumen/components'
...
```js
import { ButtonControls } from '@lumen/components'
