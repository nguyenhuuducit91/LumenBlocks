...
addFilter( 'lumen.card.design.no-text-attributes', 'lumen/card', attributes => {
...
addFilter( 'lumen.card.design.filtered-block-attributes', 'lumen/card', ( attributes, blockAttributes = null ) => {
	return {
		...omit( attributes, [
