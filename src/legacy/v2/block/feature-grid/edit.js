...
addFilter( 'lumen.feature-grid.edit.layouts', 'default', layouts => {
	const newLayouts = [
		{
...
addFilter( 'lumen.feature-grid.edit.inspector.layout.before', 'lumen/feature-grid', ( output, props ) => {
	...
	return (
		<Fragment>
			...
			<DesignPanelBody
				initialOpen={ true }
				selected={ design }
				options={ applyFilters( 'lumen.feature-grid.edit.layouts', [] ) }
				onChange={ design => {
...
addFilter( 'lumen.feature-grid.edit.inspector.style.before', 'lumen/feature-grid', ( output, props ) => {
	const { setAttributes } = props
	const {
		columns,
		borderRadius = '',
				...
				{ show.titleSpacing &&
					...
					>
						<AdvancedRangeControl
							...
							placeholder="16"
							allowReset={ true }
							className="lmb--help-tip-spacing-title"
						/>
					</ResponsiveControl>
				}
...
const edit = props => {
	...
	const mainClasses = classnames( [
		...
		`lmb-feature-grid--design-${ design }`,
	], applyFilters( 'lumen.feature-grid.mainclasses', {
	}, props ) )
			...
			<Fragment>
				{ range( 1, columns + 1 ).map( i => {
					...
					const itemClasses = classnames( [
						...
						`lmb-feature-grid__item${ i }`,
					], applyFilters( 'lumen.feature-grid.itemclasses', {
...
export default compose(
	...
	withClickOpenInspector( [
		[ '.lmb-feature-grid__item', 'column-background' ],
		[ '.lmb-feature-grid__title', 'title' ],
		[ '.lmb-feature-grid__description', 'description' ],
		[ '.lmb-button', 'button' ],
	] ),
