 ...
 */
import { FeatureGridIcon } from '~lumen/icons'
...
export const settings = {
	...
	modules: {
		...
		'block-designs': true,
		'custom-css': {
			default: applyFilters( 'lumen.feature-grid.custom-css.default', '' ),
		},
	},
}

// If the alignment was changed, but the design doesn't support it, go back to the basic design to allow the alignment change.
addFilter( 'lumen.feature-grid.setAttributes', 'lumen/feature-grid/imageShape', attributes => {
