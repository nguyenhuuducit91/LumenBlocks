...
export default {
	...
	...createAllCombinationAttributes(
		'image%sUrl', {
			...
			default: '',
			source: 'attribute',
			selector: '.lmb-feature-grid__item%d .lmb-feature-grid__image img',
			attribute: 'src',
		},
		[ '1', '2', '3', '4' ]
	),
	...
	...createAllCombinationAttributes(
		'title%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-feature-grid__item%d .lmb-feature-grid__title',
	...
	...createAllCombinationAttributes(
		'description%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-feature-grid__item%d .lmb-feature-grid__description',
	...
	...createButtonAttributes( 'button1%s', {
		selector: '.lmb-feature-grid__item1 .lmb-button',
	} ),
	...createButtonAttributes( 'button2%s', {
		selector: '.lmb-feature-grid__item2 .lmb-button',
	} ),
	...createButtonAttributes( 'button3%s', {
		selector: '.lmb-feature-grid__item3 .lmb-button',
	} ),
	...createButtonAttributes( 'button4%s', {
		selector: '.lmb-feature-grid__item4 .lmb-button',
	} ),
