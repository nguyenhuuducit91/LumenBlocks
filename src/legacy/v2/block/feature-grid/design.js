...
addFilter( 'lumen.feature-grid.design.no-text-attributes', 'lumen/feature-grid', attributes => {
...
addFilter( 'lumen.feature-grid.design.filtered-block-attributes', 'lumen/feature-grid', ( attributes, blockAttributes = null ) => {
	return {
		...omit( attributes, [
			'image1Id',
