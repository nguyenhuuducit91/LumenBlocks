...
addFilter( 'lumen.heading.edit.inspector.style.before', 'lumen/heading', ( output, props ) => {
				...
				{ show.topLineSpacing && (
					...
					>
						<AdvancedRangeControl
							...
							placeholder="16"
							allowReset={ true }
							className="lmb--help-tip-spacing"
						/>
					</ResponsiveControl>
				) }
				<ResponsiveControl
...
const edit = props => {
	...
	const mainClasses = classnames( [
		className,
	], applyFilters( 'lumen.heading.mainclasses', {
	}, props ) )

	return (
		<BlockContainer.Edit className={ mainClasses } blockProps={ props } render={ () => (
			<Fragment>
				{ showTopLine && <div className="lmb-heading__top-line" /> }
				<RichText
					tagName={ titleTag || 'h2' }
					className="lmb-heading__title"
					value={ title }
				...
				{ showSubtitle &&
					<RichText
						tagName="p"
						className="lmb-heading__subtitle"
						value={ subtitle }
				...
				{ showBottomLine && <div className="lmb-heading__bottom-line" /> }
			</Fragment>
		) } />
	)
}
...
export default compose(
	...
	withClickOpenInspector( [
		[ '.lmb-heading__title', 'title' ],
		[ '.lmb-heading__subtitle', 'subtitle' ],
		[ '.lmb-heading__top-line', 'topline' ],
		[ '.lmb-heading__bottom-line', 'bottomline' ],
	] ),
)( edit )
