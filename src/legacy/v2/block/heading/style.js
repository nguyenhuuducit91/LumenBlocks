...
export const createStyles = props => {
	...
	if ( showTitle ) {
		const titleColorSelector = applyFilters( 'lumen.heading.styles.title.color-selector', '.lmb-heading__title', props )
		styles.push( {
			[ titleColorSelector ]: {
	...
	if ( showTopLine ) {
		styles.push( {
			'.lmb-heading__top-line': appendImportantAll( {
		...
		styles.push( ...createResponsiveMarginAlign( '.lmb-heading__top-line', 'topLine%sAlign', props.attributes ) )
	}
	...
	if ( showBottomLine ) {
		styles.push( {
			'.lmb-heading__bottom-line': appendImportantAll( {
		...
		styles.push( ...createResponsiveMarginAlign( '.lmb-heading__bottom-line', 'bottomLine%sAlign', props.attributes ) )
	}

	// Spacing.
	styles.push( ...createResponsiveStyles( '.lmb-heading__title', 'title%sBottomMargin', 'marginBottom', '%spx', props.attributes, { important: true } ) )
	if ( show.subtitleSpacing ) {
		styles.push( ...createResponsiveStyles( '.lmb-heading__subtitle', 'subtitle%sBottomMargin', 'marginBottom', '%spx', props.attributes, { important: true } ) )
	}
	if ( show.topLineSpacing ) {
		styles.push( ...createResponsiveStyles( '.lmb-heading__top-line', 'topLine%sBottomMargin', 'marginBottom', '%spx', props.attributes, { important: true } ) )
	}
	if ( show.bottomLineSpacing ) {
		styles.push( ...createResponsiveStyles( '.lmb-heading__bottom-line', 'bottomLine%sBottomMargin', 'marginBottom', '%spx', props.attributes, { important: true } ) )
	}
