...
addFilter( 'lumen.testimonial.design.no-text-attributes', 'lumen/testimonial', attributes => {
...
addFilter( 'lumen.testimonial.design.filtered-block-attributes', 'lumen/testimonial', ( attributes, blockAttributes = null ) => {
	return {
		...omit( attributes, [
			'image1Id',
