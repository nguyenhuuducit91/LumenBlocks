 ...
 */
import { TestimonialIcon } from '~lumen/icons'
...
export const settings = {
	...
	modules: {
		...
		'container-link': true,
		'custom-css': {
			default: applyFilters( 'lumen.testimonial.custom-css.default', '' ),
		},
	},
}

// Reset some attributes if some global attributes are set.
addFilter( 'lumen.testimonial.setAttributes', 'lumen/testimonial/imageShape', attributes => {
