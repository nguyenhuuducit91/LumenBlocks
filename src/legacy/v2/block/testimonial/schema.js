...
export default {
	...
	...createAllCombinationAttributes(
		'testimonial%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-testimonial__item%d .lmb-testimonial__body',
	...
	...createAllCombinationAttributes(
		'image%sAlt', {
			...
			default: '',
			source: 'attribute',
			selector: '.lmb-testimonial__item%d .lmb-testimonial__image img',
			attribute: 'alt',
		},
		[ '1', '2', '3' ]
	),
	...
	...createAllCombinationAttributes(
		'name%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-testimonial__item%d .lmb-testimonial__name',
	...
	...createAllCombinationAttributes(
		'position%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-testimonial__item%d .lmb-testimonial__position',
