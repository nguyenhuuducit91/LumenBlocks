...
addFilter( 'lumen.testimonial.edit.layouts', 'default', layouts => {
	const newLayouts = [
		{
...
addFilter( 'lumen.testimonial.edit.inspector.layout.before', 'lumen/testimonial', ( output, props ) => {
	...
	return (
		<Fragment>
			...
			<DesignPanelBody
				initialOpen={ true }
				selected={ design }
				options={ applyFilters( 'lumen.testimonial.edit.layouts', [] ) }
				onChange={ design => {
...
addFilter( 'lumen.testimonial.edit.inspector.style.before', 'lumen/testimonial', ( output, props ) => {
	const { setAttributes } = props
	const {
		design = 'basic',
		columns = 2,
	...
	return (
		<Fragment>
			...
			{ applyFilters( 'lumen.testimonial.edit.inspector.style.general.after', null, props ) }
			...
			{ show.columnBackground &&
				...
				>
					{ applyFilters( 'lumen.testimonial.edit.inspector.style.container.before',
						<Fragment>
							<ButtonIconPopoverControl
			...
			{ applyFilters( 'lumen.testimonial.edit.inspector.style.testimonial.after', null, props ) }
							...
							<div className="lmb-testimonial__person">
								...
								{ show.imageAsBackground && showImage &&
									<ImageUploadPlaceholder
										...
										imageURL={ imageUrl }
										imageSize={ imageSize }
										className="lmb-testimonial__image"
										onRemove={ () => {
											setAttributes( {
												[ `image${ i }Url` ]: '',
												[ `image${ i }Id` ]: '',
...
export default compose(
	...
	withClickOpenInspector( [
		[ '.lmb-testimonial__item', 'column-background' ],
		[ '.lmb-testimonial__body', 'testimonial' ],
		[ '.lmb-testimonial__name', 'name' ],
		[ '.lmb-testimonial__position', 'position' ],
	] ),
