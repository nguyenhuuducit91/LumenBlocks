...
const deprecatedSchema_1_17_3 = {
	...
	name1: {
		source: 'html',
		selector: '.lmb-testimonial__item:nth-of-type(1) .lmb-testimonial__name',
		default: __( 'Name', i18n ),
	},
	name2: {
		source: 'html',
		selector: '.lmb-testimonial__item:nth-of-type(2) .lmb-testimonial__name',
		default: __( 'Name', i18n ),
	},
	name3: {
		source: 'html',
		selector: '.lmb-testimonial__item:nth-of-type(3) .lmb-testimonial__name',
		default: __( 'Name', i18n ),
	},
	position1: {
		source: 'html',
		selector: '.lmb-testimonial__item:nth-of-type(1) .lmb-testimonial__position',
		default: __( 'Position', i18n ),
	},
	position2: {
		source: 'html',
		selector: '.lmb-testimonial__item:nth-of-type(2) .lmb-testimonial__position',
		default: __( 'Position', i18n ),
	},
	position3: {
		source: 'html',
		selector: '.lmb-testimonial__item:nth-of-type(3) .lmb-testimonial__position',
		default: __( 'Position', i18n ),
	},
	testimonial1: {
		source: 'html',
		selector: '.lmb-testimonial__item:nth-of-type(1) .lmb-testimonial__body',
		default: descriptionPlaceholder( 'medium' ),
	},
	testimonial2: {
		source: 'html',
		selector: '.lmb-testimonial__item:nth-of-type(2) .lmb-testimonial__body',
		default: descriptionPlaceholder( 'medium' ),
	},
	testimonial3: {
		source: 'html',
		selector: '.lmb-testimonial__item:nth-of-type(3) .lmb-testimonial__body',
		default: descriptionPlaceholder( 'medium' ),
	},
	titleColor: {
		type: 'string',
...
const deprecatedSave_1_17_3 = props => {
	...
	], applyFilters( 'lumen.testimonial.mainclasses_1_17_3', {
		'lmb-testimonial--serif': serif,
	}, design, props ) )

	const itemClasses = classnames( [
		'lmb-testimonial__item',
	], applyFilters( 'lumen.testimonial.itemclasses_1_17_3', {
		[ `lmb--shadow-${ shadow }` ]: design !== 'plain' && shadow !== 3,
	}, design, props ) )

	const styles = applyFilters( 'lumen.testimonial.styles_1_17_3', {
		item: {
	...
	return (
		<div className={ mainClasses }>
			{ applyFilters( 'lumen.testimonial.save.output.before_1_17_3', null, design, props ) }
			{ range( 1, columns + 1 ).map( i => {
				...
				], applyFilters( 'lumen.testimonial.bodyclasses_1_17_3', {}, design, props ) )
				...
				return (
					<div className={ itemClasses } style={ styles.item } key={ i }>
						...
						<div className="lmb-testimonial__person">
							{ mediaURL && (
								<div className="lmb-testimonial__image" style={ { backgroundImage: `url(${ mediaURL })` } }></div>
							) }
			...
			{ applyFilters( 'lumen.testimonial.save.output.after_1_17_3', null, design, props ) }
		</div>
	)
}
