...
addFilter( 'lumen.divider.edit.layouts', 'default', layouts => {
	const newLayouts = [
		{
...
addFilter( 'lumen.divider.edit.inspector.layout.before', 'lumen/divider', ( output, props ) => {
	...
	return (
		<Fragment>
			...
			<DesignPanelBody
				initialOpen={ true }
				selected={ design }
				options={ applyFilters( 'lumen.divider.edit.layouts', [] ) }
...
addFilter( 'lumen.divider.edit.inspector.style.before', 'lumen/divider', ( output, props ) => {
	const { setAttributes } = props
	const {
		color = '',
		hrMarginTop = '',
		...
		<Fragment>
			...
			>
				...
				<FourRangeControl
					...
					enableLeft={ false }
					enableRight={ false }
					className="lmb--help-tip-divider-margin"
				/>
				<AdvancedRangeControl
