...
const deprecatedSave_1_17_3 = props => {
	...
	const mainClasses = classnames( [
		className,
		'lmb-divider',
	], applyFilters( 'lumen.divider.mainclasses_1_17_3', {}, design, props ) )

	return (
		<div className={ mainClasses }>
			{ applyFilters( 'lumen.divider.save.output.before_1_17_3', null, design, props ) }
			...
			/>
			{ applyFilters( 'lumen.divider.save.output.after_1_17_3', null, design, props ) }
		</div>
	)
}
