...
addFilter( 'lumen.feature.edit.layouts', 'default', layouts => {
	const newLayouts = [
		{
...
addFilter( 'lumen.feature.edit.inspector.layout.before', 'lumen/feature', ( output, props ) => {
	...
	return (
		<Fragment>
			...
			<DesignPanelBody
				initialOpen={ true }
				selected={ design }
				options={ applyFilters( 'lumen.feature.edit.layouts', [] ) }
				onChange={ design => {
...
addFilter( 'lumen.feature.edit.inspector.style.before', 'lumen/feature', ( output, props ) => {
	const { setAttributes } = props
	const {
		borderRadius = '',
		shadow = '',
				...
				{ show.imageColumnWidth &&
					...
					>
						<AdvancedRangeControl
							...
							allowReset={ true }
							placeholder="50"
							className="lmb--help-tip-image-column-width"
						/>
					</ResponsiveControl>
				}
					...
					{ show.containerWidth &&
						...
						>
							<AdvancedRangeControl
								...
								max={ 1000 }
								allowReset={ true }
								className="lmb--help-tip-feature-container-width"
							/>
						</ResponsiveControl>
					}
					{ show.containerOffset &&
						...
						>
							<AdvancedRangeControl
								...
								max={ 300 }
								allowReset={ true }
								className="lmb--help-tip-feature-container-offset"
							/>
						</ResponsiveControl>
					}
...
export default compose(
	...
	withClickOpenInspector( [
		[ '.lmb-feature__item', 'column-background' ],
		[ '.lmb-feature__title', 'title' ],
		[ '.lmb-feature__description', 'description' ],
		[ '.lmb-button', 'button' ],
	] ),
