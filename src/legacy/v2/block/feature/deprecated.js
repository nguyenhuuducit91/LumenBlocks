...
const deprecatedSave_1_17_2 = props => {
	...
	], applyFilters( 'lumen.feature.mainclasses_1_17_2', {
		[ `lmb-feature--content-${ contentAlign }` ]: contentAlign,
		'lmb-feature--invert': invert,
		'lmb--has-background': design !== 'plain' && ( backgroundColor || backgroundImageURL ),
		'lmb--has-background-image': design !== 'plain' && backgroundImageURL,
		[ `lmb--content-width` ]: align === 'full' && contentWidth,
		[ `lmb--shadow-${ shadow }` ]: design !== 'plain' && shadow !== 3,
		[ `lmb--has-background-gradient` ]: design !== 'plain' && backgroundColorType === 'gradient',
		[ `lmb--has-background-video` ]: design !== 'plain' && backgroundType === 'video',
	}, design, props ) )

	const imageClasses = classnames( [
		'lmb-feature__image',
	], applyFilters( 'lumen.feature.imageclasses_1_17_2', {
		[ `lmb--shadow-${ shadow }` ]: design === 'plain',
	}, design, props ) )
	...
	const styles = applyFilters( 'lumen.feature.styles_1_17_2', {
		main: {
	...
	return (
		<div className={ mainClasses } style={ styles.main }>
			...
			{ applyFilters( 'lumen.feature.save.output.before_1_17_2', null, design, props ) }
			{ applyFilters( 'lumen.feature.save.output_1_17_2', (
				<div className="lmb-content-wrapper">
					<div className="lmb-feature__content">
						{ titleComp }
						{ descriptionComp }
						{ buttonComp }
					</div>
