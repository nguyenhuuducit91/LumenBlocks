...
addFilter( 'lumen.pricing-box.edit.layouts', 'default', layouts => {
	const newLayouts = [
		{
...
addFilter( 'lumen.pricing-box.edit.inspector.layout.before', 'lumen/pricing-box', ( output, props ) => {
	...
	return (
		<Fragment>
			...
			<DesignPanelBody
				initialOpen={ true }
				selected={ design }
				options={ applyFilters( 'lumen.pricing-box.edit.layouts', [] ) }
				onChange={ design => {
...
addFilter( 'lumen.pricing-box.edit.inspector.style.before', 'lumen/pricing-box', ( output, props ) => {
	const { setAttributes } = props
	const {
		columns,
		titleColor,
	...
	return (
		<Fragment>
			...
			{ applyFilters( 'lumen.pricing-box.edit.inspector.style.general.after', null, props ) }
				...
				{ show.imageSpacing &&
					...
					>
						<AdvancedRangeControl
							...
							placeholder="16"
							allowReset={ true }
							className="lmb--help-tip-pricing-image-spacing"
						/>
					</ResponsiveControl>
				}
				{ show.titleSpacing && (
					...
					>
						<AdvancedRangeControl
							...
							placeholder="16"
							allowReset={ true }
							className="lmb--help-tip-pricing-title-spacing"
						/>
					</ResponsiveControl>
				) }
				{ show.priceSpacing && (
					...
					>
						<AdvancedRangeControl
							...
							placeholder="16"
							allowReset={ true }
							className="lmb--help-tip-pricing-price-spacing"
						/>
					</ResponsiveControl>
				) }
				{ show.subPriceSpacing && (
					...
					>
						<AdvancedRangeControl
							...
							placeholder="16"
							allowReset={ true }
							className="lmb--help-tip-pricing-subprice-spacing"
						/>
					</ResponsiveControl>
				) }
				{ show.buttonSpacing && (
					...
					>
						<AdvancedRangeControl
							...
							placeholder="32"
							allowReset={ true }
							className="lmb--help-tip-pricing-button-spacing"
						/>
					</ResponsiveControl>
				) }
				{ show.descriptionSpacing && (
					...
					>
						<AdvancedRangeControl
							...
							placeholder="16"
							allowReset={ true }
							className="lmb--help-tip-pricing-description-spacing"
						/>
					</ResponsiveControl>
				) }
			</PanelSpacingBody>

			{ applyFilters( 'lumen.pricing-box.edit.inspector.style.column.after', null, props ) }
			...
			{ show.imageSettings &&
				...
				>
					...
					>
						<AlignButtonsControl
							label={ __( 'Align', i18n ) }
							className="lmb--help-tip-pricing-image-align"
						/>
					</ResponsiveControl>
				</PanelAdvancedSettings>
			}
			...
			>
				...
				>
					<AlignButtonsControl
						label={ __( 'Align', i18n ) }
						className="lmb--help-tip-pricing-title-align"
					/>
				</ResponsiveControl>
			</PanelAdvancedSettings>
			...
			>
				...
				>
					<AlignButtonsControl
						label={ __( 'Align', i18n ) }
						className="lmb--help-tip-pricing-price-align"
					/>
				</ResponsiveControl>
			</PanelAdvancedSettings>
			...
			>
				...
				>
					<AlignButtonsControl
						label={ __( 'Align', i18n ) }
						className="lmb--help-tip-pricing-subprice-align"
					/>
				</ResponsiveControl>
			</PanelAdvancedSettings>
			...
			>
				...
				>
					<AlignButtonsControl
						label={ __( 'Align', i18n ) }
						className="lmb--help-tip-pricing-button-align"
					/>
				</ResponsiveControl>
			</PanelAdvancedSettings>
...
const edit = props => {
	...
	], applyFilters( 'lumen.pricing-box.mainclasses', {
	}, props ) )
				...
				{ range( 1, columns + 1 ).map( i => {
					...
					const imageBgComp = (
						<ImageUploadPlaceholder
							...
							imageURL={ imageUrl }
							imageSize={ imageSize }
							className="lmb-pricing-box__image"
							onRemove={ () => {
								setAttributes( {
									[ `image${ i }Url` ]: '',
									[ `image${ i }Id` ]: '',
					...
					return (
						<DivBackground
							...
							key={ i }
						>
							{ applyFilters( 'lumen.pricing-box.edit.content', (
								<Fragment>
									{ showImage && imageComp }
									{ showTitle && titleComp }
									{ showPrice && priceComp }
...
export default compose(
	...
	withClickOpenInspector( [
		[ '.lmb-pricing-box__header', 'column-header' ],
		[ '.lmb-pricing-box__item', 'column-background' ],
		[ '.lmb-pricing-box__title', 'title' ],
		[ '.lmb-pricing-box__price-prefix', 'price-prefix' ],
		[ '.lmb-pricing-box__price', 'price' ],
		[ '.lmb-pricing-box__price-suffix', 'price-suffix' ],
		[ '.lmb-pricing-box__subprice', 'subprice' ],
		[ '.lmb-button', 'button' ],
		[ '.lmb-pricing-box__description', 'description' ],
	] ),
