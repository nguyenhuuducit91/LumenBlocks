...
addFilter( 'lumen.pricing-box.design.no-text-attributes', 'lumen/pricing-box', attributes => {
...
addFilter( 'lumen.pricing-box.design.filtered-block-attributes', 'lumen/pricing-box', ( attributes, blockAttributes = null ) => {
	return {
		...omit( attributes, [
			'image1Id',
