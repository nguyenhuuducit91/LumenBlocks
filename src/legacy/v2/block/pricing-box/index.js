 ...
 */
import { PricingBoxIcon } from '~lumen/icons'
...
export const settings = {
	...
	modules: {
		...
		'container-link': true,
		'custom-css': {
			default: applyFilters( 'lumen.pricing-box.custom-css.default', '' ),
		},
	},
}

// Reset some attributes if some global attributes are set.
addFilter( 'lumen.pricing-box.setAttributes', 'lumen/pricing-box/imageShape', attributes => {
