...
export default {
	...
	...createAllCombinationAttributes(
		'image%sUrl', {
			...
			// source: 'attribute',
			// selector: '.lmb-pricing-box__item%d .lmb-pricing-box__image img',
			// attribute: 'src',
		},
		[ '1', '2', '3' ]
	),
	...
	...createAllCombinationAttributes(
		'title%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-pricing-box__item%d .lmb-pricing-box__title',
	...
	...createAllCombinationAttributes(
		'pricePrefix%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-pricing-box__item%d .lmb-pricing-box__price-prefix',
			default: '$',
		},
		[ '1', '2', '3' ]
	),
	...
	...createAllCombinationAttributes(
		'price%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-pricing-box__item%d .lmb-pricing-box__price',
			default: '9',
		},
		[ '1', '2', '3' ]
	),
	...
	...createAllCombinationAttributes(
		'priceSuffix%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-pricing-box__item%d .lmb-pricing-box__price-suffix',
			default: '.00',
		},
		[ '1', '2', '3' ]
	),
	...
	...createAllCombinationAttributes(
		'subPrice%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-pricing-box__item%d .lmb-pricing-box__subprice',
	...
	...createButtonAttributes( 'button1%s', {
		selector: '.lmb-pricing-box__item1 .lmb-button',
	} ),
	...createButtonAttributes( 'button2%s', {
		selector: '.lmb-pricing-box__item2 .lmb-button',
	} ),
	...createButtonAttributes( 'button3%s', {
		selector: '.lmb-pricing-box__item3 .lmb-button',
	} ),
	...
	...createAllCombinationAttributes(
		'description%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-pricing-box__item%d .lmb-pricing-box__description',
