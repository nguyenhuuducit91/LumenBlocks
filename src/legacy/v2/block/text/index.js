...
import { TextIcon } from '~lumen/icons'
...
export const settings = {
	...
	modules: {
		...
		'block-designs': true,
		'custom-css': {
			default: applyFilters( 'lumen.text.custom-css.default', '' ),
		},
	},
}

// If the design was changed, force turn on the title.
addFilter( 'lumen.text.setAttributes', 'lumen/text/design', ( attributes, blockProps ) => {
