...
export const createStyles = props => {
	...
	styles.push( {
		...
		editor: {
			desktopTablet: {
				'> .lmb-inner-block > .lmb-block-content > .lmb-icon__content-wrapper': appendImportantAll( {
					paddingTop: getValue( 'columnPaddingTop', `%s${ columnPaddingUnit }` ),
					paddingBottom: getValue( 'columnPaddingBottom', `%s${ columnPaddingUnit }` ),
					paddingRight: getValue( 'columnPaddingRight', `%s${ columnPaddingUnit }` ),
					paddingLeft: getValue( 'columnPaddingLeft', `%s${ columnPaddingUnit }` ),
	...
	// Icon.
	styles.push( { ...createIconStyleSet( 'icon%s', 'lmb-icon__icon', props.attributes ) } )
	if ( show.iconAlign ) {
		styles.push( {
			'.lmb-icon__icon': appendImportantAll( {
	...
	// Spacing.
	styles.push( ...createResponsiveStyles( '.lmb-icon__icon', 'icon%sBottomMargin', 'marginBottom', '%spx', props.attributes, { important: true } ) )
	if ( show.titleSpacing ) {
		styles.push( ...createResponsiveStyles( '.lmb-icon__title', 'title%sBottomMargin', 'marginBottom', '%spx', props.attributes, { important: true } ) )
	}

	// Advanced Column Gap
	styles.push( {
		'.lmb-icon__content-wrapper': {
