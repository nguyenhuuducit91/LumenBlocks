...
export default {
	...
	...createAllCombinationAttributes(
		'link%sUrl', {
			...
			default: '',
			source: 'attribute',
			selector: '.lmb-image-box__item%d .lmb-image-box__overlay-link',
			attribute: 'href',
		},
		[ '1', '2', '3', '4' ]
	),
	...
	...createAllCombinationAttributes(
		'subtitle%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-image-box__item%d .lmb-image-box__subtitle',
	...
	...createAllCombinationAttributes(
		'title%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-image-box__item%d .lmb-image-box__title',
	...
	...createAllCombinationAttributes(
		'description%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-image-box__item%d .lmb-image-box__description',
