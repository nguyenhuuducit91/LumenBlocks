...
addFilter( 'lumen.image-box.design.no-text-attributes', 'lumen/image-box', attributes => {
...
addFilter( 'lumen.image-box.design.filtered-block-attributes', 'lumen/image-box', ( attributes, blockAttributes = null ) => {
	return {
		...omit( attributes, [
			'link1Url',
			'link2Url',
