...
export const createStyles = props => {
	...
	if ( show.borderRadius ) {
		styles.push( {
			[ `.${ uniqueClass }-wrapper.lmb-container__wrapper` ]: {
			...
			editor: {
				[ `.${ uniqueClass }-wrapper.lmb-container__wrapper > .lmb-video-background, ` +
				  `.${ uniqueClass }-wrapper.lmb-container__wrapper:before` ]: {
	...
	if ( show.border ) {
		styles.push( {
			...createBorderStyleSet( 'column%s', `.${ uniqueClass }-wrapper.lmb-container__wrapper`, props.attributes ),
		} )
	}
	...
	styles.push( {
		saveOnly: {
			'> .lmb-inner-block > .lmb-block-content > *': {
		...
		editor: {
			'> .lmb-inner-block > .lmb-block-content > .lmb-container__wrapper': {
				justifyContent: appendImportant( getValue( 'columnContentVerticalAlign' ) ),
			},
			tablet: {
				'> .lmb-inner-block > .lmb-block-content > .lmb-container__wrapper': {
	...
	styles.push( {
		[ `.${ uniqueClass }-wrapper > .lmb-container__side` ]: {
	...
	styles.push( {
		desktopTablet: {
			[ `.${ uniqueClass }-content-wrapper.lmb-container__content-wrapper` ]: {
	...
	styles.push( {
		...( show.columnBackground ? createBackgroundStyleSet( 'column%s', `${ uniqueClass }-wrapper.lmb-container__wrapper`, props.attributes, columnBackgroundOptions ) : {} ),
	} )
	...
	const containerSelector = applyFilters( 'lumen.container.spacing-paddings.selector', '> .lmb-inner-block > .lmb-block-content > *', props )
	const containerSelectorEditor = applyFilters( 'lumen.container.spacing-paddings.selector', '> .lmb-inner-block > .lmb-block-content > .lmb-container__wrapper', props )
	styles.push( {
		saveOnly: {
			desktopTablet: {
	...
	// Don't color all children since Lumen blocks and others might have their own background colors.
	styles.push( {
