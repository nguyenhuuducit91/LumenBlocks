...
import { cacheImageData } from '~lumen/utils'
...
addFilter( 'lumen.container.edit.layouts', 'default', layouts => {
	const newLayouts = [
		{
...
addFilter( 'lumen.container.edit.inspector.layout.before', 'lumen/container', ( output, props ) => {
	...
	return (
		<Fragment>
			...
			<DesignPanelBody
				initialOpen={ true }
				selected={ design }
				options={ applyFilters( 'lumen.container.edit.layouts', [] ) }
...
addFilter( 'lumen.container.edit.inspector.style.before', 'lumen/container', ( output, props ) => {
	const { setAttributes } = props
	const {
		borderRadius = '',
		shadow = '',
	...
	return (
		<Fragment>
			...
			{ applyFilters( 'lumen.container.edit.inspector.style.column-background.after', null, props ) }
	...
	return (
		<BlockContainer.Edit className={ mainClasses } blockProps={ props } render={ () => (
			<Fragment>
				...
				>
					{ applyFilters( 'lumen.container.edit.wrapper.output', null, props ) }
