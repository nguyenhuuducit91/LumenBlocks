...
export const createStyles = props => {
	...
	if ( show.border ) {
		styles.push( {
			...createBorderStyleSet( 'column%s', '.lmb-number-box__item', props.attributes ),
		} )
	}
	...
	styles.push( {
		...( show.columnBackground ? createBackgroundStyleSet( 'column%s', 'lmb-number-box__item', props.attributes, columnBackgroundOptions ) : {} ),
	} )
	...
	styles.push( {
		...
		editor: {
			desktopTablet: {
				'> .lmb-inner-block > .lmb-block-content > .lmb-number-box__item': appendImportantAll( {
					paddingTop: getValue( 'columnPaddingTop', `%s${ columnPaddingUnit }` ),
					paddingBottom: getValue( 'columnPaddingBottom', `%s${ columnPaddingUnit }` ),
					paddingRight: getValue( 'columnPaddingRight', `%s${ columnPaddingUnit }` ),
					paddingLeft: getValue( 'columnPaddingLeft', `%s${ columnPaddingUnit }` ),
	...
	if ( show.numberSpacing ) {
		styles.push( ...createResponsiveStyles( '.lmb-number-box__number', 'number%sBottomMargin', 'marginBottom', '%spx', props.attributes, { important: true } ) )
	}
	if ( show.titleSpacing ) {
		styles.push( ...createResponsiveStyles( '.lmb-number-box__title', 'title%sBottomMargin', 'marginBottom', '%spx', props.attributes, { important: true } ) )
	}
	if ( show.descriptionSpacing ) {
		styles.push( ...createResponsiveStyles( '.lmb-number-box__description', 'description%sBottomMargin', 'marginBottom', '%spx', props.attributes, { important: true } ) )
	}
