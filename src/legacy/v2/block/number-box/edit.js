...
addFilter( 'lumen.number-box.edit.layouts', 'default', layouts => {
	const newLayouts = [
		{
...
addFilter( 'lumen.number-box.edit.inspector.layout.before', 'lumen/number-box', ( output, props ) => {
	...
	return (
		<Fragment>
			...
			<DesignPanelBody
				initialOpen={ true }
				selected={ design }
				options={ applyFilters( 'lumen.number-box.edit.layouts', [] ) }
				onChange={ design => {
...
addFilter( 'lumen.number-box.edit.inspector.style.before', 'lumen/number-box', ( output, props ) => {
	const { setAttributes } = props
	const {
		columns,
		numberColor,
		...
		<Fragment>
				...
				{ show.numberSpacing && (
					...
					>
						<AdvancedRangeControl
							...
							placeholder="16"
							allowReset={ true }
							className="lmb--help-tip-spacing-number"
						/>
					</ResponsiveControl>
				) }
				{ show.titleSpacing && (
			...
			>
				...
				>
					<AlignButtonsControl
						label={ __( 'Align', i18n ) }
						className="lmb--help-tip-alignment-number"
					/>
				</ResponsiveControl>
			</PanelAdvancedSettings>
...
export default compose(
	...
	withClickOpenInspector( [
		[ '.lmb-number-box__item', 'column-background' ],
		[ '.lmb-number-box__number', 'number' ],
		[ '.lmb-number-box__title', 'title' ],
		[ '.lmb-number-box__description', 'description' ],
	] ),
)( edit )
