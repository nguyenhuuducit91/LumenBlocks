...
addFilter( 'lumen.video-popup.edit.inspector.style.before', 'lumen/video-popup', ( output, props ) => {
			...
			>
					...
					<Fragment>
						<WhenResponsiveScreen screen="desktop">
							<AdvancedRangeControl
								...
								className="lmb--help-tip-video-popup-width"
							/>
						</WhenResponsiveScreen>
				...
				>
					<AdvancedRangeControl
						...
						allowReset={ true }
						placeholder="400"
						className="lmb--help-tip-video-popup-height"
					/>
				</ResponsiveControl>
...
export default compose(
	...
	withClickOpenInspector( [
		[ '.lmb-video-popup__wrapper', 'background' ],
		[ '.lmb-video-popup__play-button svg', 'play-button' ],
	] ),
)( edit )
