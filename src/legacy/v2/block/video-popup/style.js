...
export const createStyles = props => {
	...
	if ( show.border ) {
		styles.push( {
			...createBorderStyleSet( 'column%s', '.lmb-video-popup__wrapper', props.attributes ),
		} )
	}
	...
	styles.push( {
		...
		'.lmb-video-popup__play-button svg': {
	...
	styles.push( {
		...createBackgroundStyleSet( 'preview%s', 'lmb-video-popup__wrapper', props.attributes ),
	} )
	...
	if ( previewBackgroundTintStrength || previewBackgroundColor ) {
		styles.push( {
			'.lmb-video-popup__wrapper:hover:before': {
