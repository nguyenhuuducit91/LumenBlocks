...
const playButton = {
	normal: <SVGNormalIcon className="lmb-play-button-normal" width="30" height="30" />,
	circle: <SVGCircleIcon className="lmb-play-button-cirle" width="50" height="50" />,
	outline: <SVGOutlineIcon className="lmb-play-button-outline" width="50" height="50" />,
}
...
export const showOptions = blockProps => {
	...
	return applyFilters( 'lumen.video-popup.show', {
