...
addFilter( 'lumen.column.edit.layouts', 'default', layouts => {
	const newLayouts = [
		{
...
addFilter( 'lumen.column.edit.inspector.layout.before', 'lumen/column', ( output, props ) => {
	...
	return (
		<Fragment>
			...
			>
				<DesignControl
					selected={ design }
					options={ applyFilters( 'lumen.column.edit.layouts', [] ) }
...
addFilter( 'lumen.column.edit.inspector.style.before', 'lumen/column', ( output, props ) => {
	const { setAttributes } = props
	const {
		contentWidth = '',
		contentWidthUnit = '%',
