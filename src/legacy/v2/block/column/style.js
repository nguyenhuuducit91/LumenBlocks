...
export const createStyles = props => {
	...
	if ( show.borderRadius ) {
		styles.push( {
			...
			editor: {
				[ `.${ uniqueClass }-wrapper > .lmb-video-background, ` +
	...
	styles.push( {
		saveOnly: first( createResponsiveStyles( '> .lmb-inner-block > .lmb-block-content > *', '%sColumnContentVerticalAlign', 'justifyContent', '%s', props.attributes, { important: true } ) ),
		editor: first( createResponsiveStyles( '> .lmb-inner-block > .lmb-block-content > .lmb-column__item', '%sColumnContentVerticalAlign', 'justifyContent', '%s', props.attributes, { important: true } ) ),
	} )

	// Content Width
	styles.push( {
		[ `.${ uniqueClass }-column-wrapper .lmb-column__content-wrapper` ]: {
	...
	styles.push( {
		...
		editor: {
			desktopTablet: {
				'> .lmb-inner-block > .lmb-block-content > .lmb-column__item': appendImportantAll( {
					paddingTop: getValue( 'columnPaddingTop', `%s${ columnPaddingUnit }` ),
					paddingBottom: getValue( 'columnPaddingBottom', `%s${ columnPaddingUnit }` ),
					paddingRight: getValue( 'columnPaddingRight', `%s${ columnPaddingUnit }` ),
					paddingLeft: getValue( 'columnPaddingLeft', `%s${ columnPaddingUnit }` ),
