...
export const deprecatedSave_1_15 = props => {
	...
	return (
		<div className={ mainClasses } style={ mainStyle } aria-hidden="true">
			{ applyFilters( 'lumen.separator.save.output.before_1_15', null, design, props ) }
			<div className="lmb-separator__top-pad" style={ topPadStyle }></div>
			<div className="lmb-separator__svg-wrapper" style={ svgWrapperStyle }>
				<div className="lmb-separator__svg-inner">
					{ layer1Shadow && <Shadow preserveAspectRatio="none" style={ layer1Style } /> }
					<Separator preserveAspectRatio="none" style={ layer1Style } />
					{ applyFilters( 'lumen.separator.save.output.layers_1_15', null, design, props ) }
				</div>
			</div>
			<div className="lmb-separator__bottom-pad" style={ bottomPadStyle }></div>
		</div>
	)
}
