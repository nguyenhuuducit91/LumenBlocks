...
addFilter( 'lumen.separator.edit.inspector.layout.excludeDesigns', 'default', ret => {
...
addFilter( 'lumen.separator.edit.inspector.layout.before', 'lumen/separator', ( output, props ) => {
		...
		<Fragment>
			...
			<DesignPanelBody>
				<DesignSeparatorControl
					...
					selected={ design }
					excludeDesigns={ applyFilters( 'lumen.separator.edit.inspector.layout.excludeDesigns', [] ) }
				/>
			</DesignPanelBody>
		</Fragment>
	)
...
addFilter( 'lumen.separator.edit.inspector.style.before', 'lumen/separator', ( output, props ) => {
	const { setAttributes } = props
	const {
		height,
		tabletHeight = '',
...
export default compose(
	...
	withClickOpenInspector( [
		[ '.lmb-separator__layer-1', 'separator' ],
	] ),
)( edit )
