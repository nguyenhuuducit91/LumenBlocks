...
const deprecated = [
	{
		...
		migrate: attributes => {
			...
			const updateCSS = css => ( css || '' )
				.replace( /\.lmb-blog-posts__category-list/g, '.lmb-blog-posts__category' )
				.replace( /\.lmb-blog-posts__read_more/g, '.lmb-blog-posts__readmore' )
				.replace( /\.lmb-blog-posts__side/g, '.lmb-blog-posts__content' )
