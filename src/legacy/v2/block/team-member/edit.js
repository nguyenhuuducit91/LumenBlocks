...
addFilter( 'lumen.team-member.edit.layouts', 'default', layouts => {
	const newLayouts = [
		{
...
addFilter( 'lumen.team-member.edit.inspector.layout.before', 'lumen/team-member', ( output, props ) => {
	...
	return (
		<Fragment>
			...
			<DesignPanelBody
				initialOpen={ true }
				selected={ design }
				options={ applyFilters( 'lumen.team-member.edit.layouts', [] ) }
...
addFilter( 'lumen.team-member.edit.inspector.style.before', 'lumen/team-member', ( output, props ) => {
	const { setAttributes } = props
	const {
		columns,
		borderRadius = '',
		...
		<Fragment>
				...
				{ show.imageSpacing &&
					...
					>
						<AdvancedRangeControl
							...
							placeholder="24"
							allowReset={ true }
							className="lmb--help-tip-spacing-image"
						/>
					</ResponsiveControl>
				}
				{ show.nameSpacing &&
					...
					>
						<AdvancedRangeControl
							...
							placeholder="8"
							allowReset={ true }
							className="lmb--help-tip-spacing-name"
						/>
					</ResponsiveControl>
				}
				...
				{ show.descriptionSpacing &&
					...
					>
						<AdvancedRangeControl
							...
							placeholder="16"
							allowReset={ true }
							className="lmb--help-tip-spacing-description"
						/>
					</ResponsiveControl>
				}
				{ show.socialSpacing &&
					...
					>
						<AdvancedRangeControl
							...
							placeholder="4"
							allowReset={ true }
							className="lmb--help-tip-spacing-button"
						/>
					</ResponsiveControl>
				}
				{ show.socialSpacing &&
					...
					>
						<AdvancedRangeControl
							...
							placeholder="0"
							allowReset={ true }
							className="lmb--help-tip-spacing-button-gap"
						/>
					</ResponsiveControl>
				}
			</PanelSpacingBody>
			...
			>
				...
				>
					<AlignButtonsControl
						label={ __( 'Align', i18n ) }
						className="lmb--help-tip-alignment-name"
					/>
				</ResponsiveControl>
			</PanelAdvancedSettings>
			...
			{ show.social &&
				...
				>
					<div className="components-base-control">
						<div className="components-base-control__label lmb-team-member-setting__social-label">{ __( 'Social Buttons', i18n ) }</div>
						{ Object.keys( SOCIAL_SITES ).map( socialId => {
							return (
								<ToggleControl
									key={ socialId }
									className="lmb-team-member-setting__social"
						...
						>
							...
							{ show.imageAsBackground &&
								<ImageUploadPlaceholder
									...
									imageURL={ imageUrl }
									imageSize={ imageSize }
									className="lmb-team-member__image"
									onRemove={ () => {
										setAttributes( {
											[ `image${ i }Url` ]: '',
											[ `image${ i }Id` ]: '',
...
export default compose(
	...
	withClickOpenInspector( [
		[ '.lmb-team-member__item', 'column-background' ],
		[ '.lmb-team-member__name', 'name' ],
		[ '.lmb-team-member__position', 'position' ],
		[ '.lmb-team-member__description', 'description' ],
		[ '.lmb-button', 'social' ],
	] ),
