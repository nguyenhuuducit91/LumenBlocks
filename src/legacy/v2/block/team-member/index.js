 ...
 */
import { TeamMemberIcon } from '~lumen/icons'
...
export const settings = {
	...
	modules: {
		...
		'container-link': true,
		'custom-css': {
			default: applyFilters( 'lumen.team-member.custom-css.default', '' ),
		},
	},
}

// Reset some attributes if some global attributes are set.
addFilter( 'lumen.team-member.setAttributes', 'lumen/team-member/imageShape', attributes => {
