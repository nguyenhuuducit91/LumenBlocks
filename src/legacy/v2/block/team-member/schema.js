...
export default {
	...
	...createAllCombinationAttributes(
		'image%sUrl', {
			...
			// source: 'attribute',
			// selector: '.lmb-team-member__item%d .lmb-team-member__image img',
			// attribute: 'src',
		},
		[ '1', '2', '3' ]
	),
	...
	...createAllCombinationAttributes(
		'name%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-team-member__item%d .lmb-team-member__name',
	...
	...createAllCombinationAttributes(
		'position%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-team-member__item%d .lmb-team-member__position',
	...
	...createAllCombinationAttributes(
		'description%s', {
			type: 'string',
			source: 'html',
			selector: '.lmb-team-member__item%d .lmb-team-member__description',
	...
	...createSocialButtonAttributes( 'social1%s', {
		selector: '.lmb-team-member__item1 .lmb-button-%s',
		facebookDefault: '',
		twitterDefault: '',
		instagramDefault: '',
		pinterestDefault: '',
	...
	...createSocialButtonAttributes( 'social2%s', {
		selector: '.lmb-team-member__item2 .lmb-button-%s',
		facebookDefault: '',
		twitterDefault: '',
		instagramDefault: '',
		pinterestDefault: '',
	...
	...createSocialButtonAttributes( 'social3%s', {
		selector: '.lmb-team-member__item3 .lmb-button-%s',
		facebookDefault: '',
		twitterDefault: '',
		instagramDefault: '',
		pinterestDefault: '',
