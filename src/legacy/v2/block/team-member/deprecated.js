...
const deprecatedSchema_1_17_3 = {
	...
	mediaURL1: {
		type: 'string',
		source: 'attribute',
		selector: '.lmb-team-member__item:nth-of-type(1) .lmb-team-member__image',
		attribute: 'data-src',
		default: '',
	},
	mediaURL2: {
		type: 'string',
		source: 'attribute',
		selector: '.lmb-team-member__item:nth-of-type(2) .lmb-team-member__image',
		attribute: 'data-src',
		default: '',
	},
	mediaURL3: {
		type: 'string',
		source: 'attribute',
		selector: '.lmb-team-member__item:nth-of-type(3) .lmb-team-member__image',
		attribute: 'data-src',
		default: '',
	},
	name1: {
		source: 'html',
		selector: '.lmb-team-member__item:nth-of-type(1) .lmb-team-member__name',
		default: __( 'Name', i18n ),
	},
	name2: {
		source: 'html',
		selector: '.lmb-team-member__item:nth-of-type(2) .lmb-team-member__name',
		default: __( 'Name', i18n ),
	},
	name3: {
		source: 'html',
		selector: '.lmb-team-member__item:nth-of-type(3) .lmb-team-member__name',
		default: __( 'Name', i18n ),
	},
	position1: {
		source: 'html',
		selector: '.lmb-team-member__item:nth-of-type(1) .lmb-team-member__position',
		default: __( 'Position', i18n ),
	},
	position2: {
		source: 'html',
		selector: '.lmb-team-member__item:nth-of-type(2) .lmb-team-member__position',
		default: __( 'Position', i18n ),
	},
	position3: {
		source: 'html',
		selector: '.lmb-team-member__item:nth-of-type(3) .lmb-team-member__position',
		default: __( 'Position', i18n ),
	},
	description1: {
		source: 'html',
		selector: '.lmb-team-member__item:nth-of-type(1) .lmb-team-member__description',
		default: descriptionPlaceholder( 'medium' ),
	},
	description2: {
		source: 'html',
		selector: '.lmb-team-member__item:nth-of-type(2) .lmb-team-member__description',
		default: descriptionPlaceholder( 'medium' ),
	},
	description3: {
		source: 'html',
		selector: '.lmb-team-member__item:nth-of-type(3) .lmb-team-member__description',
		default: descriptionPlaceholder( 'medium' ),
	},
	nameColor: {
		type: 'string',
...
const deprecatedSave_1_17_3 = props => {
	...
	const mainClasses = classnames( [
		...
		`lmb-team-member--image-${ shapes }`,
		`lmb-team-member--design-${ design }`,
	], applyFilters( 'lumen.team-member.mainclasses_1_17_3', {}, design, props ) )

	return (
		<div className={ mainClasses }>
			{ applyFilters( 'lumen.team-member.save.output.before_1_17_3', null, design, props ) }
			{ range( 1, columns + 1 ).map( i => {
				...
				], applyFilters( 'lumen.team-member.itemclasses_1_17_3', {
					[ `lmb--shadow-${ shadow }` ]: design !== 'plain' && shadow !== 3,
				}, design, i, props ) )

				const styles = applyFilters( 'lumen.team-member.itemstyles_1_17_3', {
					item: {
				...
				return (
					<div className={ itemClasses } style={ styles.item } key={ i }>
						{ applyFilters( 'lumen.team-member.save.output_1_17_3', (
							<Fragment>
								{ imageComp }
			...
			{ applyFilters( 'lumen.team-member.save.output.after', null, design, props ) }
		</div>
	)
}
