...
addFilter( 'lumen.team-member.design.no-text-attributes', 'lumen/team-member', attributes => {
...
addFilter( 'lumen.team-member.design.filtered-block-attributes', 'lumen/team-member', ( attributes, blockAttributes = null ) => {
	return {
		...omit( attributes, [
			'image1Id',
