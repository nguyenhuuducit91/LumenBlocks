...
export const createStyles = props => {
	...
	styles.push( {
		'> .lmb-inner-block > .lmb-block-content > .lmb-columns__item': {
		...
		editor: {
			'> .lmb-inner-block > .lmb-block-content > .lmb-columns__item > .block-editor-inner-blocks > .block-editor-block-list__layout': {
				gridTemplateColumns: ! columnRanges.every( c => c === '1.00fr' ) ? appendImportant( columnRanges.join( ' ' ) ) : undefined,
			},
			tablet: {
				'> .lmb-inner-block > .lmb-block-content > .lmb-columns__item > .block-editor-inner-blocks > .block-editor-block-list__layout': {
	...
	styles.push( ...createResponsiveStyles( `.${ uniqueClass }-content-wrapper > .lmb-column`, '%sColumnVerticalAlign', 'alignItems', '%s', props.attributes, { important: true } ) )
	styles.push( ...createResponsiveStyles( `.${ uniqueClass }-content-wrapper > .lmb-column > .lmb-inner-block`, '%sColumnVerticalAlign', 'height', 'auto', props.attributes, { important: true } ) )
	...
	styles.push( {
		editor: {
			[ `${ columnEditorSelector } > .lmb-column` ]: {
