...
addFilter( 'lumen.blockquote.edit.layouts', 'default', layouts => {
	const newLayouts = [
		{
...
addFilter( 'lumen.blockquote.edit.inspector.layout.before', 'lumen/blockquote', ( output, props ) => {
	...
	return (
		<Fragment>
			...
			<DesignPanelBody
				initialOpen={ true }
				selected={ design }
				options={ applyFilters( 'lumen.blockquote.edit.layouts', [] ) }
...
addFilter( 'lumen.blockquote.edit.inspector.style.before', 'lumen/blockquote', ( output, props ) => {
	const { setAttributes } = props
	const {
		borderRadius = '',
		shadow = '',
		...
		<Fragment>
			...
			>
				<AdvancedToolbarControl
					label={ __( 'Icon', i18n ) }
					multiline={ true }
					className="lmb-blockquote__inspector__icon"
...
export default compose(
	...
	withClickOpenInspector( [
		[ '.lmb-blockquote__item', 'column-background' ],
		[ '.lmb-blockquote__quote', 'quotation' ],
		[ '.lmb-blockquote__text', 'text' ],
	] ),
)( edit )
