...
export default {
	...
	icon: {
		type: 'string',
		source: 'html',
		selector: '.lmb-notification__icon .lmb-icon-inner-svg,' +
			// This one is for backward compatibility <= 2.6.
			'.lmb-notification__item:not(.lmb-notification--new-icon)',
	...
	title: {
		source: 'html',
		selector: '.lmb-notification__title',
	...
	description: {
		source: 'html',
		selector: '.lmb-notification__description',
	...
	...createButtonAttributes( 'button%s', { selector: '.lmb-button' } ),
	buttonDesign: {
		type: 'string',
		default: 'ghost',
	},
