...
addFilter( 'lumen.notification.edit.layouts', 'default', layouts => {
	const newLayouts = [
		{
...
addFilter( 'lumen.notification.edit.inspector.layout.before', 'lumen/notification', ( output, props ) => {
	...
	return (
		<Fragment>
			...
			<DesignPanelBody
				initialOpen={ true }
				selected={ design }
				options={ applyFilters( 'lumen.notification.edit.layouts', [] ) }
				onChange={ design => {
...
addFilter( 'lumen.notification.edit.inspector.style.before', 'lumen/notification', ( output, props ) => {
	const { setAttributes } = props
	const {
		titleColor,
		descriptionColor,
	...
	return (
		<Fragment>
					...
					{ show.iconSpacing &&
						...
						>
							<AdvancedRangeControl
								...
								placeholder="16"
								allowReset={ true }
								className="lmb--help-tip-spacing-icon"
							/>
						</ResponsiveControl>
					}
					{ show.titleSpacing &&
			...
			<PanelAdvancedSettings
				...
				className="lmb--help-tip-notification-dismissible"
			>
				<ResponsiveControl
			...
			>
				...
				{ show.iconAlign &&
					...
					>
						<AlignButtonsControl
							label={ __( 'Align', i18n ) }
							className="lmb--help-tip-alignment-icon"
						/>
					</ResponsiveControl>
				}
			</PanelAdvancedSettings>
...
export default compose(
	...
	withClickOpenInspector( [
		[ '.lmb-notification__item', 'column-background' ],
		[ '.lmb-notification__close-button', 'dismissible' ],
		[ '.lmb-notification__icon svg', 'icon' ],
		[ '.lmb-notification__title', 'title' ],
		[ '.lmb-notification__description', 'description' ],
		[ '.lmb-button', 'button' ],
	] ),
)( edit )
