 ...
 */
import { NotificationIcon } from '~lumen/icons'
...
export const settings = {
	...
	modules: {
		...
		'block-designs': true,
		'custom-css': {
			default: applyFilters( 'lumen.notification.custom-css.default', '' ),
		},
	},
}

addFilter( 'lumen.notification.setAttributes', 'lumen/notification/notifType', attributes => {
...
addFilter( 'lumen.notification.setAttributes', 'lumen/notification/opacity', ( attributes, blockProps ) => {
