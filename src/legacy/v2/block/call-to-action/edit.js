...
addFilter( 'lumen.cta.edit.layouts', 'default', layouts => {
	const newLayouts = [
		{
...
addFilter( 'lumen.cta.edit.inspector.layout.before', 'lumen/cta', ( output, props ) => {
	...
	return (
		<Fragment>
			...
			<DesignPanelBody
				initialOpen={ true }
				selected={ design }
				options={ applyFilters( 'lumen.cta.edit.layouts', [] ) }
...
addFilter( 'lumen.cta.edit.inspector.style.before', 'lumen/cta', ( output, props ) => {
	const { setAttributes } = props
	const {
		titleColor,
		descriptionColor,
		...
		<Fragment>
			...
			>
				...
				<TypographyControlHelper
					...
					setAttributes={ setAttributes }
					blockAttributes={ props.attributes }
					className="lmb--help-tip-typography-family"
					htmlTag={ titleTag || 'h3' }
				/>
				<ColorPaletteControl
					value={ titleColor }
		...
		<BlockContainer.Edit className={ mainClasses } blockProps={ props } render={ () => (
			<Fragment>
				<DivBackground
					...
					blockProps={ props }
				>
					{ applyFilters( 'lumen.cta.edit.output', (
						<Fragment>
							{ titleComp }
							{ descriptionComp }
							{ buttonComp }
