...
addFilter( 'lumen.header.edit.layouts', 'default', layouts => {
	const newLayouts = [
		{
...
addFilter( 'lumen.header.edit.inspector.layout.before', 'lumen/header', ( output, props ) => {
	...
	return (
		<Fragment>
			...
			<DesignPanelBody
				initialOpen={ true }
				selected={ design }
				options={ applyFilters( 'lumen.header.edit.layouts', [] ) }
				onChange={ design => {
...
addFilter( 'lumen.header.edit.inspector.style.before', 'lumen/header', ( output, props ) => {
	const { setAttributes } = props
	const {
		design = 'basic',
		borderRadius = '',
		...
		<Fragment>
			...
			>
				...
				<AdvancedToggleControl
					...
					className="lmb--help-tip-full-height"
				/>
				{ show.restrictContent &&
					<AdvancedToggleControl
						...
						className="lmb--help-tip-general-restrict-content"
					/>
				}
				<ContentAlignControl
					...
					return (
						...
						>
							<div className="lmb-content-wrapper">
								{ applyFilters( 'lumen.header.edit.output', (
									<Fragment>
										{ showTitle && titleComp }
...
export default compose(
	...
	withClickOpenInspector( [
		[ '.lmb-content-wrapper', 'overlay-background' ],
		[ '.lmb-header__item', 'column-background' ],
		[ '.lmb-header__title', 'title' ],
		[ '.lmb-header__subtitle', 'subtitle' ],
		[ '.lmb-button1', 'button1' ],
		[ '.lmb-button2', 'button2' ],
	] ),
)( edit )
