...
const deprecatedSchema_1_15_5 = {
	...
	url2: {
		type: 'string',
		source: 'attribute',
		selector: 'div:nth-of-type(2) .lmb-button',
		attribute: 'href',
		default: '',
	},
	newTab2: {
	...
	text2: {
		source: 'html',
		selector: 'div:nth-of-type(2) .lmb-button span',
		default: __( 'Button text', i18n ),
	},
	color2: {
		type: 'string',
	...
	url3: {
		type: 'string',
		source: 'attribute',
		selector: 'div:nth-of-type(3) .lmb-button',
		attribute: 'href',
		default: '',
	},
	newTab3: {
	...
	text3: {
		source: 'html',
		selector: 'div:nth-of-type(3) .lmb-button span',
		default: __( 'Button text', i18n ),
	},
	color3: {
		type: 'string',
...
export const deprecatedSave_1_15_5 = props => {
	...
	const mainClasses = classnames( [
		newClassName,
		'lmb-button-wrapper',
	], applyFilters( 'lumen.button.mainclasses_1_15_5', {
		[ `lmb-button--align-${ align }` ]: align,
	}, design, props ) )
	...
	const saved = (
		<div className={ mainClasses }>
			{ range( 1, buttons + 1 ).map( i => {
				...
				// 	applyFilters( 'lumen.button.buttonclasses', {}, design, i, props )
				// )
			...
			{ applyFilters( 'lumen.button.save.output.after_1_15_5', null, design, props ) }
		</div>
	)

	return saved
	// return applyFilters( 'lumen.designs.button.save', saved, props )
}

const migrate_1_15_5 = attributes => {
	// Update the custom CSS since the structure has changed.
	const updateCSS = css => ( css || '' )
		.replace( /.lmb-button-wrapper > \*:nth-child\((\d)\) .lmb-button--inner/g, '.lmb-button-wrapper .lmb-button$1 .lmb-button--inner' )
		.replace( /.lmb-button-wrapper > \*:nth-child\((\d)\) .lmb-button([^-])/g, '.lmb-button-wrapper .lmb-button$1$2' )
