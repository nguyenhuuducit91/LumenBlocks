...
2. Afterwards, all the contents of `dist/frontend_blocks_responsive.css` are also placed inside the `lumen_get_responsive_css` function in `src/dynamic-breakpoints.php`. This is also done via Gulp.
