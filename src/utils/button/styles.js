...
export const createButtonStyleSet = ( attrNameTemplate = '%s', mainClassName = '', blockAttributes = {}, options = {} ) => {
	...
	styles.push( {
		[ `.${ mainClassName } .lmb-button--inner` ]: {
	...
	if ( getValue( 'Design' ) === '' || getValue( 'Design' ) === 'basic' ) {
		styles.push( {
			...
			[ `.${ mainClassName } .lmb-button--inner, .${ mainClassName } svg:not(.lmb-custom-icon)` ]: {
				color: appendImportant( whiteIfDarkBlackIfLight( getValue( 'TextColor' ), getValue( 'BackgroundColor' ) ) ),
			},
			[ `.${ mainClassName }:hover .lmb-button--inner, .${ mainClassName }:hover svg:not(.lmb-custom-icon)` ]: {
			...
			...( hasActiveStyles ? {
				...
				[ `.${ mainClassName }.is-active .lmb-button--inner, .${ mainClassName }.is-active svg:not(.lmb-custom-icon)` ]: {
					color: appendImportant( whiteIfDarkBlackIfLight( getValue( 'HoverTextColor' ), getValue( 'HoverBackgroundColor' ) ) ),
				},
				[ `.${ mainClassName }:focus` ]: {
	...
	if ( getValue( 'Design' ) === 'ghost' ) {
		styles.push( {
			...
			[ `.${ mainClassName }:hover .lmb-button--inner` ]: {
			...
			...( hasActiveStyles ? {
				...
				[ `.${ mainClassName }:focus .lmb-button--inner` ]: {
					color: getValue( 'HoverBackgroundColor' ) !== '' ? appendImportant( getValue( 'HoverBackgroundColor' ) )
						: ( getValue( 'BackgroundColor' ) !== '' ? appendImportant( getValue( 'BackgroundColor' ) ) : undefined ),
				},
				[ `.${ mainClassName }.is-active` ]: {
				...
				[ `.${ mainClassName }.is-active .lmb-button--inner` ]: {
					color: getValue( 'HoverBackgroundColor' ) !== '' ? appendImportant( getValue( 'HoverBackgroundColor' ) )
						: ( getValue( 'BackgroundColor' ) !== '' ? appendImportant( getValue( 'BackgroundColor' ) ) : undefined ),
				},
			} : {} ),
		...
		if ( getValue( 'Icon' ) !== '' || hasIcon ) {
			styles.push( {
				[ `.${ mainClassName }.lmb-button--has-icon.lmb-button--has-icon svg:not(.lmb-custom-icon)` ]: {
					color: getValue( 'BackgroundColor' ) !== '' ? getValue( 'BackgroundColor' ) : undefined,
				},
				[ `.${ mainClassName }.lmb-button--has-icon.lmb-button--has-icon:hover svg:not(.lmb-custom-icon)` ]: {
	...
	if ( getValue( 'Design' ) !== 'link' ) {
		...
		styles.push( {
			...
			[ `.${ mainClassName }.lmb-button--has-icon.lmb-button--has-icon svg` ]: {
