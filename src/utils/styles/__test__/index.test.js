...
describe( 'createResponsiveStyles', () => {
	it( 'should generate responsive styles', () => {
		const selector = '.lmb-sample-block'
		...
		expect( createResponsiveStyles( selector, attrNameTemplate, styleRule, format, attributes1, { important: false } ) ).toEqual( [ {
			'.lmb-sample-block': { sampleStyleRule: '30px' }, mobile: { '.lmb-sample-block': {} }, tabletOnly: { '.lmb-sample-block': {} },
		} ] )
		expect( createResponsiveStyles( selector, attrNameTemplate, styleRule, format, attributes1, { important: true } ) ).toEqual( [ {
			'.lmb-sample-block': { sampleStyleRule: '30px !important' }, mobile: { '.lmb-sample-block': {} }, tabletOnly: { '.lmb-sample-block': {} },
		} ] )
		expect( createResponsiveStyles( selector, attrNameTemplate, styleRule, format, attributes1, { important: true, inherit: false } ) ).toEqual( [ {
			desktopOnly: { '.lmb-sample-block': { sampleStyleRule: '30px !important' } }, mobile: { '.lmb-sample-block': {} }, tabletOnly: { '.lmb-sample-block': {} },
		} ] )
		expect( createResponsiveStyles( selector, attrNameTemplate, styleRule, format, attributes1, {
			...
			'.lmb-sample-block': { sampleStyleRule: '30px !important' }, mobile: { '.lmb-sample-block': {} }, tabletOnly: { '.lmb-sample-block': { sampleStyleRule: '25px !important' } },
		} ] )
		expect( createResponsiveStyles( selector, attrNameTemplate, styleRule, format, attributes1, {
			important: true, inheritMobileMax: 25, inheritMobileMin: 20,
		} ) ).toEqual( [ {
			'.lmb-sample-block': { sampleStyleRule: '30px !important' }, mobile: { '.lmb-sample-block': { sampleStyleRule: '25px !important' } }, tabletOnly: { '.lmb-sample-block': {} },
		} ] )
		expect( createResponsiveStyles( selector, attrNameTemplate, styleRule, format, attributes1, {
		...
		expect( createResponsiveStyles( selector, attrNameTemplate, styleRule, format, attributes1, {
			...
			'.lmb-sample-block': { sampleStyleRule: '30px !important' }, mobile: { '.lmb-sample-block': { sampleStyleRule: '25px !important' } }, tabletOnly: { '.lmb-sample-block': { sampleStyleRule: '35px !important' } },
		} ] )
	} )
} )
