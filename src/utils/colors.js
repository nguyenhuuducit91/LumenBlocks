...
export const hexToRgba = ( hexColor, opacity = null ) => {
	...
	const overrideOutput = applyFilters( 'lumen.util.hex-to-rgba', null, hexColor, opacity )
	if ( overrideOutput ) {
		return overrideOutput
	}

	let hex = applyFilters( 'lumen.util.hex-to-rgba.hex', hexColor, opacity )
 ...
 *
 * color: var(--lmn-global-color-10793, #00ffe1) opacity: 0.4 new color:
 * color-mix(in srgb, var(--lmn-global-color-10793, #00ffe1) 40%, transparent)
 *
