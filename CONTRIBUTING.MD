...
> Hold up! This document is a work in progress. It's currently a mixture of an outline & dev notes. We'll [Tweet](https://twitter.com/wplumen) when it's ready, [so follow us](https://twitter.com/wplumen).

We're thrilled that you want to help out in Lumen. This document should help you get started with everything you need.
...
This is to prevent errors when upgrading Lumen.
...
>
> Output an HTML containing the saved block HTMLs + Block frontend CSS + Block frontend JS + Lumen's general CSS. All blocks should be working, with default / filled in attribute values. For easy manual visual inspection.
