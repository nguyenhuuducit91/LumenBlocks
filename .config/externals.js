...
/**
 * These are all the Lumen modules that are exported by our main script as
 * our API. Some scripts (like premium or deprecated code) will reference our
 * API externally.
 */
const lumenExternals = [
	'ui',
	'features',
	'design-library',
	'hoc',
	...
	...externals,
	[ `~lumen/${ name }` ]: `lmn.${ camelCaseDash( name ) }`,
} ), {} );

const externals = {
	wp: 'wp',
	lodash: 'lodash', // WP loads lodash already.
	lumen: 'lumen', // Our localized JS variable.
