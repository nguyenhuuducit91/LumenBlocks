...
* does a fake registration of every Lumen block so that
* the WordPress plugin directory detects them and lists them
* in the Lumen plugin page.
*
...
const registerBlocks = glob.sync( './src/block-library/*/index.js' ).reduce( ( code, file ) => {
