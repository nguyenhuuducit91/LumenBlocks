...
/**
 * Builds the Playwright CI matrix from Lumen's supported WordPress versions
...
const PLAYWRIGHT_MATRIX_START = '# lumen-playwright-matrix-start'
const PLAYWRIGHT_MATRIX_END = '# lumen-playwright-matrix-end'
...
const replaceMatrixInWorkflow = ( content, matrix ) => {
	...
	return content.replace(
		/(# lumen-playwright-matrix-start\n)[\s\S]*?(\n\s*# lumen-playwright-matrix-end)/,
		`$1${ block }$2`
	)
}
